...
public interface DocAccessLogMapper extends BaseMapper<DocAccessLog> {
    ...
    @Select("<script>" +
            ...
            "</script>")
    IPage<DocAccessLog> selectLogPage(Page<DocAccessLog> page,
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<Map<String, Object>> countByUser(@Param("documentId") Long documentId,
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<Map<String, Object>> countByDocument(@Param("userId") Long userId,
                                                        @Param("startTime") String startTime,
                                                        @Param("endTime") String endTime);
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<Map<String, Object>> countByActionType(@Param("documentId") Long documentId,
                                                            @Param("userId") Long userId,
                                                            @Param("startTime") String startTime,
                                                            @Param("endTime") String endTime);
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<Map<String, Object>> countByDate(@Param("documentId") Long documentId,
                                                     @Param("userId") Long userId,
                                                     @Param("startTime") String startTime,
                                                     @Param("endTime") String endTime);
    ...
    @Select("<script>" +
            ...
            "</script>")
    List<Map<String, Object>> queryAuditReport(@Param("documentId") Long documentId,
                                                          @Param("userId") Long userId,
                                                          @Param("actionType") String actionType,
                                                          @Param("startTime") String startTime,
                                                          @Param("endTime") String endTime);
