...
public interface ResignationMapper extends BaseMapper<Resignation> {
    ...
    @Select("""
        ...
        """)
    IPage<Resignation> selectResignationPage(Page<Resignation> page,
     ...
     * 根据员工ID查询离职申请
     */
    @Select("SELECT * FROM hr_resignation WHERE employee_id = #{employeeId} AND deleted = false ORDER BY resignation_date DESC")
