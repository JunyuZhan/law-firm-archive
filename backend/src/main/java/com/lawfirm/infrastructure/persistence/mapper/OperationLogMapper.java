...
public interface OperationLogMapper extends BaseMapper<OperationLog> {
  ...
  @org.apache.ibatis.annotations.Update(
      "UPDATE sys_operation_log SET deleted = true, updated_at = CURRENT_TIMESTAMP "
          + "WHERE created_at < #{beforeDate} AND deleted = false")
   ...
   */
  @Select(
      "SELECT COUNT(*) FROM sys_operation_log WHERE created_at < #{beforeDate} AND deleted = false")
