...
public class PdfReportGenerator {
  ...
  /** 标题下边距：20 */
  private static final float TITLE_MARGIN_BOTTOM = 20f;

  /** 表格列宽比例：1.5 */
  private static final float TABLE_COLUMN_WIDTH_1_5 = 1.5f;

  /** 表格列宽比例：2.5 */
  private static final float TABLE_COLUMN_WIDTH_2_5 = 2.5f;

  /** 表格列宽比例：0.8 */
  private static final float TABLE_COLUMN_WIDTH_0_8 = 0.8f;

  /** 表格列宽比例：1.2 */
  private static final float TABLE_COLUMN_WIDTH_1_2 = 1.2f;

  /** 表格列宽比例：1.8 */
  private static final float TABLE_COLUMN_WIDTH_1_8 = 1.8f;
  ...
  public ByteArrayInputStream generateRevenueReport(final List<Map<String, Object>> data)
    ...
    // 创建表格
    Table table =
        new Table(UnitValue.createPercentArray(new float[] {2, 3, 3, 2, 2})).useAllAvailableWidth();
    ...
    for (Map<String, Object> row : data) {
      ...
      table.addCell(
          createDataCell(row.get("clientName") != null ? row.get("clientName").toString() : ""));
      table.addCell(
          createDataCell(row.get("matterName") != null ? row.get("matterName").toString() : ""));
  ...
  public ByteArrayInputStream generateMatterReport(final List<Map<String, Object>> data)
    ...
    Table table =
        new Table(UnitValue.createPercentArray(new float[] {2, 3, 2, 2, TABLE_COLUMN_WIDTH_1_5, 2}))
    ...
    for (Map<String, Object> row : data) {
      table.addCell(
          createDataCell(row.get("matterNo") != null ? row.get("matterNo").toString() : ""));
      table.addCell(
          createDataCell(row.get("matterName") != null ? row.get("matterName").toString() : ""));
      table.addCell(
          createDataCell(row.get("clientName") != null ? row.get("clientName").toString() : ""));
      table.addCell(
          createDataCell(row.get("matterType") != null ? row.get("matterType").toString() : ""));
      table.addCell(createDataCell(row.get("status") != null ? row.get("status").toString() : ""));
      table.addCell(
          createDataCell(row.get("createdAt") != null ? row.get("createdAt").toString() : ""));
    }
  ...
  public ByteArrayInputStream generateClientReport(final List<Map<String, Object>> data)
    ...
    Table table =
        new Table(
                UnitValue.createPercentArray(
                    new float[] {2, 3, TABLE_COLUMN_WIDTH_1_5, 2, 2, TABLE_COLUMN_WIDTH_1_5}))
            .useAllAvailableWidth();
    ...
    for (Map<String, Object> row : data) {
      table.addCell(
          createDataCell(row.get("clientNo") != null ? row.get("clientNo").toString() : ""));
      table.addCell(
          createDataCell(row.get("clientName") != null ? row.get("clientName").toString() : ""));
      table.addCell(
          createDataCell(row.get("clientType") != null ? row.get("clientType").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("contactPerson") != null ? row.get("contactPerson").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("contactPhone") != null ? row.get("contactPhone").toString() : ""));
      table.addCell(createDataCell(row.get("status") != null ? row.get("status").toString() : ""));
    }
  ...
  public ByteArrayInputStream generateLawyerPerformanceReport(final List<Map<String, Object>> data)
    ...
    Table table =
        new Table(
                UnitValue.createPercentArray(
                    new float[] {2, TABLE_COLUMN_WIDTH_1_5, 2, TABLE_COLUMN_WIDTH_1_5, 2}))
            .useAllAvailableWidth();
    ...
    for (Map<String, Object> row : data) {
      table.addCell(
          createDataCell(row.get("lawyer_name") != null ? row.get("lawyer_name").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("matter_count") != null ? row.get("matter_count").toString() : ""));
      ...
      table.addCell(
          createDataCell(row.get("total_hours") != null ? row.get("total_hours").toString() : ""));
      table.addCell(
          createDataCell(row.get("avg_revenue") != null ? row.get("avg_revenue").toString() : ""));
    }
   ...
   * @return 表头单元格
   */
  private com.itextpdf.layout.element.Cell createHeaderCell(final String text) {
  ...
  public ByteArrayInputStream generateReceivableReport(final List<Map<String, Object>> data)
    ...
    Table table =
        new Table(
                UnitValue.createPercentArray(
                    new float[] {
                      2,
                      TABLE_COLUMN_WIDTH_2_5,
                      TABLE_COLUMN_WIDTH_1_5,
                      TABLE_COLUMN_WIDTH_1_5,
                      TABLE_COLUMN_WIDTH_1_5,
                      TABLE_COLUMN_WIDTH_1_5,
                      TABLE_COLUMN_WIDTH_1_5,
    ...
    for (Map<String, Object> row : data) {
      table.addCell(
          createDataCell(row.get("client_name") != null ? row.get("client_name").toString() : ""));
      table.addCell(
          createDataCell(row.get("matter_name") != null ? row.get("matter_name").toString() : ""));
      table.addCell(
          createDataCell(row.get("matter_no") != null ? row.get("matter_no").toString() : ""));
      table.addCell(
          createDataCell(row.get("contract_no") != null ? row.get("contract_no").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("contract_amount") != null ? row.get("contract_amount").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("received_amount") != null ? row.get("received_amount").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("receivable_amount") != null ? row.get("receivable_amount").toString() : ""));
      table.addCell(
          createDataCell(row.get("aging_days") != null ? row.get("aging_days").toString() : ""));
      table.addCell(
          createDataCell(
              row.get("receivable_status") != null ? row.get("receivable_status").toString() : ""));
    }
   ...
   * @return 数据单元格
   */
  private com.itextpdf.layout.element.Cell createDataCell(final String text) {
    return new com.itextpdf.layout.element.Cell()
