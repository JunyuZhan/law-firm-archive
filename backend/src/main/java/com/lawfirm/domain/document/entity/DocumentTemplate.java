...
public class DocumentTemplate extends BaseEntity {
   ...
   * ENFORCEMENT-执行, LEGAL_COUNSEL-法律顾问, SPECIAL_SERVICE-专项服务, ALL-通用（适用所有案件类型）
   *
   * <p>当同时存在通用模板和特定案件类型模板时，优先使用特定类型模板
   */
  @lombok.Builder.Default private String caseType = "ALL";
  ...
  /** 使用次数 */
  @lombok.Builder.Default private Integer useCount = 0;
