...
public class DataHandover extends BaseEntity {
  ...
  @lombok.Builder.Default private String status = "PENDING_APPROVAL";

  /** 关联的审批记录ID */
  private Long approvalId;

  /** 移交项目数 */
  @lombok.Builder.Default private Integer matterCount = 0;

  /** 移交客户数 */
  @lombok.Builder.Default private Integer clientCount = 0;

  /** 移交案源数 */
  @lombok.Builder.Default private Integer leadCount = 0;

  /** 移交任务数 */
  @lombok.Builder.Default private Integer taskCount = 0;
