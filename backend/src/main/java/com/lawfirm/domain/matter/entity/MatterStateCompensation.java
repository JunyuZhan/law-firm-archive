...
/** 国家赔偿案件业务信息实体 用于存储行政国家赔偿和刑事国家赔偿的扩展业务信息 */
@Data
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
...
public class MatterStateCompensation extends BaseEntity {
  ...
  /**
   * 义务机关类型 PUBLIC_SECURITY-公安机关, PROCURATORATE-检察机关, COURT-审判机关, PRISON-监狱管理机关, ADMIN_ORGAN-行政机关,
   * OTHER-其他
   */
  ...
  /** 致损行为类型 ILLEGAL_DETENTION-违法拘留, ILLEGAL_COERCIVE-违法采取强制措施, WRONGFUL_CONVICT-错误判决等 */
  ...
  /**
   * 赔偿项目明细（JSONB格式） 示例：[{"type": "人身自由赔偿", "days": 100, "daily_amount": 436.89, "amount": 43689},
  ...
  /** 决定结果 GRANTED-全部支持, DENIED-不予赔偿, PARTIAL_GRANTED-部分支持 */
  ...
  /** 支付状态 UNPAID-未支付, PAID-已支付, PARTIAL_PAID-部分支付 */
