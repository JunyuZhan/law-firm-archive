...
public class TaskCommentAppService {
    ...
    public Map<String, Object> uploadAttachmentFile(MultipartFile file, Long taskId) {
        ...
        try {
            ...
            log.info("任务评论附件文件上传成功: taskId={}, fileName={}, storagePath={}, hash={}", 
                taskId, originalFilename, storagePath, fileHash);
