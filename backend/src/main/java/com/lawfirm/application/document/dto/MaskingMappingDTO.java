...
public class MaskingMappingDTO {
     ...
     * 添加映射
     */
    public void addMapping(String fieldName, String originalValue, String maskedValue) {
        // 避免重复添加
     ...
     * 合并另一个映射
     */
    public void merge(MaskingMappingDTO other) {
    ...
    public static class MappingEntry {
        ...
        public MappingEntry(String fieldName, String originalValue, String maskedValue) {
