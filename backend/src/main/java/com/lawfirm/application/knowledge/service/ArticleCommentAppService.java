...
public class ArticleCommentAppService {
   ...
   */
  @Transactional
  public ArticleCommentDTO createComment(final CreateArticleCommentCommand command) {
    articleRepository.getByIdOrThrow(command.getArticleId(), "文章不存在");
   ...
   * @return 评论列表
   */
  public List<ArticleCommentDTO> getArticleComments(final Long articleId) {
   ...
   */
  @Transactional
  public void likeComment(final Long id) {
   ...
   * @return 评论DTO
   */
  private ArticleCommentDTO toDTO(final ArticleComment comment) {
