...
public class QualityCheckStandardAppService {
  ...
  public List<QualityCheckStandardDTO> getEnabledStandards() {
    ...
    return standards.stream().map(this::toDTO).collect(Collectors.toList());
  }
   ...
   * @return 标准列表
   */
  public List<QualityCheckStandardDTO> getStandardsByCategory(final String category) {
   ...
   */
  @Transactional
  public QualityCheckStandardDTO createStandard(final CreateQualityCheckStandardCommand command) {
   ...
   */
  @Transactional
  public QualityCheckStandardDTO updateStandard(
      final Long id, final CreateQualityCheckStandardCommand command) {
   ...
   */
  @Transactional
  public void deleteStandard(final Long id) {
   ...
   * @return 标准DTO
   */
  public QualityCheckStandardDTO getStandardById(final Long id) {
    QualityCheckStandard standard = standardRepository.getByIdOrThrow(id, "检查标准不存在");
    return toDTO(standard);
  }
   ...
   * Entity转DTO.
   *
   * @param standard 质量检查标准实体
   * @return 质量检查标准DTO
   */
  private QualityCheckStandardDTO toDTO(final QualityCheckStandard standard) {
