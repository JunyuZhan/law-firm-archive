...
public class LetterTemplateFormatter {
     ...
     * 检查内容是否为结构化格式
     */
    public boolean isStructuredFormat(String content) {
     ...
     * @return 格式化后的HTML内容
     */
    public String formatStructuredLetter(String content, Map<String, String> variables) {
        if (content == null || content.trim().isEmpty()) {
            return "<p>模板内容为空</p>";
        }
        ...
        try {
            ...
            if (blocks.has("title")) {
                ...
                if (title.has("letterTitle")) {
                    ...
                    if (!letterTitle.trim().isEmpty()) {
                        ...
                        html.append("  <h2 style=\"text-align: center; font-family: 'FZXiaoBiaoSong-B05S', '方正小标宋简体', '方正小标宋', 'FZXBS', 'FangSong', '仿宋', serif; font-size: 22pt; font-weight: normal; letter-spacing: 2pt; margin: 0 0 10px 0;\">")
                           .append(escapeHtml(letterTitle)).append("</h2>\n");
                        html.append("</div>\n");
                    }
                }
                ...
                if (title.has("letterNo")) {
                    ...
                    if (!letterNo.trim().isEmpty()) {
                        ...
                        html.append("<p style=\"text-align: right; font-family: 'FangSong', '仿宋_GB2312', '仿宋', serif; font-size: 14pt; line-height: 24pt; margin: 0 0 20px 0;\">")
                           .append(escapeHtml(letterNo)).append("</p>\n");
                    }
                }
            }
            ...
            if (blocks.has("recipient")) {
                ...
                if (!recipient.trim().isEmpty()) {
                    ...
                    html.append("<p style=\"text-indent: 0; margin-bottom: 20px; font-family: 'FangSong', '仿宋_GB2312', '仿宋', serif; font-size: 16pt; line-height: 28pt;\"><strong>")
                       .append(escapeHtml(recipient)).append("</strong></p>\n");
                }
            }
            ...
            if (blocks.has("signature")) {
                ...
                html.append("<div style=\"text-align: right; margin-top: 40px; font-family: 'FangSong', '仿宋_GB2312', '仿宋', serif; font-size: 16pt; line-height: 28pt;\">\n");
                ...
                if (signature.has("lawyerNames")) {
                    ...
                    if (!lawyerNames.trim().isEmpty()) {
                        ...
                        html.append("  <p style=\"text-indent: 0; margin: 0 0 8px 0;\">")
                           .append(escapeHtml(lawyerNames)).append("</p>\n");
                    }
                }
                ...
                if (signature.has("contactInfo")) {
                    ...
                    if (!contactInfo.trim().isEmpty()) {
                        ...
                        html.append("  <p style=\"text-indent: 0; margin: 0 0 8px 0;\">")
                           .append(escapeHtml(contactInfo)).append("</p>\n");
                    }
                }
                ...
                if (signature.has("firmName")) {
                    ...
                    if (!firmName.trim().isEmpty()) {
                        ...
                        html.append("  <p style=\"text-indent: 0; margin: 0 0 8px 0;\">")
                           .append(escapeHtml(firmName)).append("</p>\n");
                    }
                }
                ...
                if (signature.has("date")) {
                    ...
                    if (!date.trim().isEmpty()) {
                        ...
                        html.append("  <p style=\"text-indent: 0; margin: 0;\">")
                           .append(escapeHtml(date)).append("</p>\n");
                    }
                }
     ...
     */
    private String formatParagraphs(String text, boolean indent) {
        ...
        for (String line : lines) {
            ...
            if (!trimmed.isEmpty()) {
                ...
                html.append("<p style=\"font-family: 'FangSong', '仿宋_GB2312', '仿宋', serif; font-size: 16pt; line-height: 28pt; ")
