...
public class LoginLogAppService {
   ...
   * @return 分页结果
   */
  public PageResult<LoginLogDTO> listLoginLogs(final LoginLogQueryDTO query) {
   ...
   * @return 日志详情
   */
  public LoginLogDTO getLoginLog(final Long id) {
   ...
   * @return 最近登录记录列表
   */
  public List<LoginLogDTO> getRecentLogsByUserId(final Long userId, final int limit) {
   ...
   * @return 失败次数
   */
  public int countFailureByUsername(final String username) {
    // ✅ 使用可配置的时间窗口
  ...
  private LoginLogDTO toDTO(final LoginLog log) {
