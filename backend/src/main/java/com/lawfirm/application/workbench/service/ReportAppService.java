...
public class ReportAppService {
    ...
    public void generateReportAsync(Long reportId, GenerateReportCommand command, Long userId, String userName) {
        ...
        try {
            ...
            log.info("报表异步生成成功: reportNo={}, fileUrl={}, storagePath={}", 
                report.getReportNo(), report.getFileUrl(), report.getStoragePath());
    ...
    public ReportDTO generateReport(GenerateReportCommand command) {
        ...
        try {
            ...
            log.info("报表生成成功: reportNo={}, fileUrl={}, storagePath={}", 
                reportNo, report.getFileUrl(), report.getStoragePath());
        } catch (Exception e) {
     ...
     * 生成报表文件并设置存储信息
     */
    private void generateReportFile(GenerateReportCommand command, Report report) throws Exception {
        // 1. 查询数据
        ...
        originalFileName = String.format("%s_%s_%s.%s", reportTypeName, dateStr, report.getReportNo(), extension);
        ...
        log.info("报表文件生成并上传成功: fileUrl={}, storagePath={}, physicalName={}, hash={}, size={}", 
            fileUrl, storagePath, physicalName, fileHash, fileBytes.length);
    }
