...
public class LeadController {
    ...
    @GetMapping
    @RequirePermission("client:lead:list")
    ...
    @GetMapping("/{id}")
    @RequirePermission("client:lead:view")
    ...
    @PostMapping
    @RequirePermission("client:lead:create")
    ...
    @PutMapping("/{id}")
    @RequirePermission("client:lead:update")
    ...
    @DeleteMapping("/{id}")
    @RequirePermission("client:lead:delete")
    ...
    @RequirePermission("client:lead:follow")
    ...
    @RequirePermission("client:lead:convert")
