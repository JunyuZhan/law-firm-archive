...
public class NotificationTestController {
    ...
    public Result<String> testEmailConfig(@RequestBody Map<String, String> params) {
    ...
    public Result<String> sendTestAlert(@RequestBody Map<String, String> params) {
        ...
        try {
            switch (alertType) {
                ...
                case "locked":
                    ...
                    break;
                case "disk":
                    alertService.sendDiskSpaceAlert("/", 85, 15000);
                    break;
                case "backup":
    ...
    @RequirePermission("sys:config:list")
    public Result<String> previewSystemReport(@RequestParam(defaultValue = "daily") String type) {
        try {
            String report;
    ...
    public Result<String> sendSystemReport(@RequestBody Map<String, String> params) {
