 ...
 * 统一错误码枚举
 *
 * <p>错误码规则： - 1xxx: 认证授权相关 - 2xxx: 业务逻辑相关 - 3xxx: 参数校验相关 - 4xxx: 数据操作相关 - 5xxx: 系统内部错误
 *
 * @author junyuzhan
 * @since 2026-01-10
 */
...
public enum ErrorCode {
   ...
   * @return 业务异常
   */
  public BusinessException toException(final String customMessage) {
   ...
   * @return 业务异常
   */
  public BusinessException toException(final Object... args) {
