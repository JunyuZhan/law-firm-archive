 ...
 * 敏感数据脱敏工具类
 *
 * <p>功能： - 手机号脱敏 - 身份证脱敏 - 姓名脱敏 - 邮箱脱敏 - 银行卡脱敏 - 地址脱敏 - 通用脱敏
 *
 * @author junyuzhan
 * @since 2026-01-10
 */
public final class SensitiveUtils {
  ...
  public static String maskBankCard(final String bankCard) {
    ...
    return bankCard.substring(0, 4)
        + repeat(MASK_CHAR, bankCard.length() - 8)
   ...
   * @return 脱敏后的案号
   */
  public static String maskCaseNumber(final String caseNumber) {
   ...
   * @return 脱敏后的金额
   */
  public static String maskAmount(final BigDecimal amount) {
    if (amount == null) {
      return null;
    }
    return "****";
   ...
   * @return 脱敏后的合同编号
   */
  public static String maskContractNo(final String contractNo) {
   ...
   * @return 脱敏后的律师证号
   */
  public static String maskLawyerLicense(final String licenseNo) {
  ...
  /**
   * 通用脱敏 保留前prefixLength位和后suffixLength位，中间用maskChar填充
   *
   * @param text 文本
  ...
  public static String mask(
      final String text, final int prefixLength, final int suffixLength, final char maskChar) {
    if (text == null) {
      return null;
    }
   ...
   * @return 脱敏后的文本
   */
  public static String mask(final String text, final int prefixLength, final int suffixLength) {
   ...
   * @return 脱敏后的文本
   */
  public static String maskAll(final String text) {
    if (text == null) {
      return null;
    }
   ...
   * @return 脱敏后的文本
   */
  public static String maskFixed(final String text, final int maskLength) {
    if (text == null) {
      return null;
    }
