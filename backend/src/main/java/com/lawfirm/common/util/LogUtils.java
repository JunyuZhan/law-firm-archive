...
public class LogUtils {
     ...
     * @return 任务执行结果
     */
    public static <T> T logWithPerformance(String operation, Supplier<T> supplier) {
        long startTime = System.currentTimeMillis();
        try {
     ...
     * @param task 要执行的任务
     */
    public static void logSlowOperation(String operation, long thresholdMs, Runnable task) {
        long startTime = System.currentTimeMillis();
        try {
            task.run();
        } finally {
     ...
     */
    public static void debugIf(boolean condition, Supplier<String> msgSupplier) {
     ...
     * 条件日志 - INFO级别
     */
    public static void infoIf(boolean condition, Supplier<String> msgSupplier) {
     ...
     * 条件日志 - WARN级别
     */
    public static void warnIf(boolean condition, Supplier<String> msgSupplier) {
     ...
     * @param detail 详情
     */
    public static void logBusiness(String module, String action, String detail) {
     ...
     * @param detail 详情
     */
    public static void logSecurity(String event, String detail) {
     ...
     * @param result 结果
     */
    public static void logAudit(Long userId, String action, String resource, String result) {
