...
public class FieldChangeUtils {
     ...
     * @return 变更记录列表
     */
    public static List<FieldChange> compare(Object oldObj, Object newObj, Set<String> fieldNames) {
     ...
     * 将变更记录格式化为字符串
     */
    public static String formatChanges(List<FieldChange> changes) {
     ...
     */
    private static List<FieldChange> getFieldsAsChanges(Object obj, Set<String> fieldNames, boolean isNew) {
        List<FieldChange> changes = new ArrayList<>();
