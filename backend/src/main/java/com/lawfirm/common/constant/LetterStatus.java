...
public final class LetterStatus {
   ...
   *
   * @param status 模板状态值
   * @return 模板状态名称，如果状态为null则返回null
   */
  public static String getTemplateStatusName(final String status) {
    if (status == null) {
      return null;
    }
   ...
   *
   * @param status 状态值
   * @return 如果可以重新提交返回true，否则返回false
   */
  public static boolean canResubmit(final String status) {
