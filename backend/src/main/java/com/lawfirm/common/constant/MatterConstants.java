...
/** 项目/案件相关常量 统一管理项目大类、案件类型、状态等的中文名称映射 */
public final class MatterConstants {
   ...
   */
  public static String getMatterTypeName(final String matterType) {
    if (matterType == null) {
      return null;
    }
   ...
   */
  public static String getCaseTypeName(final String caseType) {
    if (caseType == null) {
      return null;
    }
   ...
   */
  public static String getMatterStatusName(final String status) {
    if (status == null) {
      return null;
    }
   ...
   */
  public static String getLitigationStageName(final String litigationStage) {
