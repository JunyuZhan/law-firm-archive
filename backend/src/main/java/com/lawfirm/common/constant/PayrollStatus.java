...
public final class PayrollStatus {
   ...
   *
   * @param status 确认状态值
   * @return 确认状态名称，如果状态为null则返回null
   */
  public static String getConfirmStatusName(final String status) {
    if (status == null) {
      return null;
    }
   ...
   *
   * @param status 状态值
   * @return 如果可以提交审批返回true，否则返回false
   */
  public static boolean canSubmitApproval(final String status) {
