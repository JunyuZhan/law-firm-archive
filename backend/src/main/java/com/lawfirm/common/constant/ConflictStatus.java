...
public final class ConflictStatus {
   ...
   * @return 是否可以申请豁免
   */
  public static boolean canApplyExemption(final String status) {
   ...
   * @return 是否存在冲突
   */
  public static boolean hasConflict(final String status) {
   ...
   * @return 是否已通过
   */
  public static boolean isPassed(final String status) {
   ...
   * @return 是否豁免待审批
   */
  public static boolean isExemptionPending(final String status) {
