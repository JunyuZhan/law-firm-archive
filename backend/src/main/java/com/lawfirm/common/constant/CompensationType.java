 ...
 * 律师薪酬模式枚举
 *
 * <p>重要：项目角色（主办/协办）与薪酬模式是两个独立维度 - 项目角色决定谁负责案件 - 薪酬模式决定是否参与提成分配
 */
public enum CompensationType {

  /** 提成制律师 - 收入主要来自案件提成 - 无固定工资或低底薪 - 参与项目提成分配 */
  COMMISSION("COMMISSION", "提成制", "按案件收入提成"),

  /** 授薪制律师 - 收入为固定月薪 - 不参与项目提成分配 - 可以担任主办/协办律师 */
  SALARIED("SALARIED", "授薪制", "固定月薪"),

  /** 混合制律师 - 有基本工资 + 案件提成 - 参与项目提成分配 - 常见于新律师过渡期 */
   ...
   * 是否有提成资格
   *
   * @return 如果有提成资格返回true，否则返回false
   */
   ...
   * 是否领取固定薪资
   *
   * @return 如果领取固定薪资返回true，否则返回false
   */
   ...
   * @return 薪酬类型
   */
  public static CompensationType fromCode(final String code) {
