...
/** TrainingNoticeAppService 单元测试 测试培训通知服务的核心功能 */
...
class TrainingNoticeAppServiceTest {
  ...
  @InjectMocks private TrainingNoticeAppService trainingNoticeAppService;
  ...
  class CreateNoticeTests {
    ...
    void createNotice_shouldFail_whenSerializeFails() throws JsonProcessingException {
      ...
      CreateTrainingNoticeCommand command = new CreateTrainingNoticeCommand();
      command.setTitle("培训");
      command.setAttachments(
          Collections.singletonList(new CreateTrainingNoticeCommand.AttachmentCommand()));
      ...
      BusinessException exception =
          assertThrows(
              BusinessException.class, () -> trainingNoticeAppService.createNotice(command));
  ...
  class QueryNoticeTests {
    ...
    void listNotices_shouldSuccess() {
      ...
      Training training =
          Training.builder().id(TEST_TRAINING_ID).title("培训通知1").status("PUBLISHED").build();
      ...
      Page<Training> pageParam1 = any(Page.class);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<Training> wrapper1 = any(LambdaQueryWrapper.class);
      when(trainingRepository.page(pageParam1, wrapper1)).thenReturn(page);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<User> wrapper2 = any(LambdaQueryWrapper.class);
      when(userRepository.count(wrapper2)).thenReturn(10L);
      when(trainingRecordRepository.countCompletedByTrainingId(any())).thenReturn(0);
    ...
    void getNoticeById_shouldSuccess() {
      ...
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<User> wrapper3 = any(LambdaQueryWrapper.class);
      when(userRepository.count(wrapper3)).thenReturn(10L);
  ...
  class CompleteTrainingTests {
    ...
    void completeTraining_shouldSuccess() {
      // Given
      Training training = Training.builder().id(TEST_TRAINING_ID).title("培训通知1").build();

      when(trainingRepository.getById(TEST_TRAINING_ID)).thenReturn(training);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<TrainingRecord> wrapper4 = any(LambdaQueryWrapper.class);
      when(trainingRecordRepository.getOne(wrapper4)).thenReturn(null);
    ...
    void completeTraining_shouldUpdate_whenRecordExists() {
      // Given
      Training training = Training.builder().id(TEST_TRAINING_ID).build();

      TrainingRecord existingRecord =
          TrainingRecord.builder().id(TEST_RECORD_ID).status("COMPLETED").build();

      when(trainingRepository.getById(TEST_TRAINING_ID)).thenReturn(training);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<TrainingRecord> wrapper5 = any(LambdaQueryWrapper.class);
      when(trainingRecordRepository.getOne(wrapper5)).thenReturn(existingRecord);
  ...
  class DeleteNoticeTests {
    ...
    void deleteNotice_shouldSuccess() {
      // Given
      Training training = Training.builder().id(TEST_TRAINING_ID).title("待删除培训").build();
  ...
  class QueryCompletionsTests {
    ...
    void listCompletions_shouldSuccess() {
      ...
      Training training = Training.builder().id(TEST_TRAINING_ID).title("培训1").build();
      ...
      @SuppressWarnings("unchecked")
      Page<TrainingRecord> pageParam2 = any(Page.class);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<TrainingRecord> wrapper7 = any(LambdaQueryWrapper.class);
      when(trainingRecordRepository.page(pageParam2, wrapper7)).thenReturn(page);
    ...
    void listCompletions_shouldReturnEmpty_whenNoRecords() {
      ...
      @SuppressWarnings("unchecked")
      Page<TrainingRecord> pageParam3 = any(Page.class);
      @SuppressWarnings("unchecked")
      LambdaQueryWrapper<TrainingRecord> wrapper8 = any(LambdaQueryWrapper.class);
      when(trainingRecordRepository.page(pageParam3, wrapper8)).thenReturn(page);
