...
class ResignationAppServiceTest {
    ...
    @InjectMocks
    private ResignationAppService resignationAppService;
    ...
    class CreateResignationTests {
        ...
        void createResignation_shouldSuccess() {
            ...
            when(resignationRepository.findByEmployeeId(TEST_EMPLOYEE_ID)).thenReturn(Collections.emptyList());
            when(resignationRepository.save(any(Resignation.class))).thenAnswer(invocation -> {
        ...
        void createResignation_shouldFail_whenPendingExists() {
            ...
            Resignation pending = Resignation.builder()
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> resignationAppService.createResignation(command));
    ...
    class ApproveResignationTests {
        ...
        void approveResignation_shouldSuccess_whenApproved() {
            ...
            // When
            ResignationDTO result = resignationAppService.approveResignation(TEST_RESIGNATION_ID, command);
    ...
    class CompleteHandoverTests {
        ...
        void completeHandover_shouldSuccess_whenAdmin() {
            ...
            securityUtilsMock.when(() -> SecurityUtils.hasAnyRole("ADMIN", "HR_MANAGER", "HR")).thenReturn(true);
        ...
        void completeHandover_shouldFail_whenNoPermission() {
            ...
            securityUtilsMock.when(() -> SecurityUtils.hasAnyRole("ADMIN", "HR_MANAGER", "HR")).thenReturn(false);
    ...
    class QueryResignationTests {
        ...
        void listResignations_shouldSuccess() {
            ...
            when(resignationMapper.selectResignationPage(any(Page.class), any(), any())).thenReturn(page);
