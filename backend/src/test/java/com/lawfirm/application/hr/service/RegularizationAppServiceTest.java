...
class RegularizationAppServiceTest {
    ...
    @Mock
    private RegularizationMapper regularizationMapper;
    ...
    @InjectMocks
    private RegularizationAppService regularizationAppService;
    ...
    class CreateRegularizationTests {
        ...
        void createRegularization_shouldSuccess() {
            ...
            when(regularizationRepository.findByEmployeeId(TEST_EMPLOYEE_ID)).thenReturn(Collections.emptyList());
            when(regularizationRepository.save(any(Regularization.class))).thenAnswer(invocation -> {
        ...
        void createRegularization_shouldFail_whenPendingExists() {
            ...
            Regularization pending = Regularization.builder()
    ...
    class ApproveRegularizationTests {
        ...
        void approveRegularization_shouldSuccess_whenApproved() {
            ...
            // When
            RegularizationDTO result = regularizationAppService.approveRegularization(TEST_REGULARIZATION_ID, command);
    ...
    class QueryRegularizationTests {
        ...
        void listRegularizations_shouldSuccess() {
            ...
            when(regularizationMapper.selectRegularizationPage(any(Page.class), any(), any())).thenReturn(page);
        ...
        void getRegularizationById_shouldSuccess() {
            ...
            // When
            RegularizationDTO result = regularizationAppService.getRegularizationById(TEST_REGULARIZATION_ID);
