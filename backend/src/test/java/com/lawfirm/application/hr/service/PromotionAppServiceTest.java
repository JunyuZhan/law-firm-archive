...
class PromotionAppServiceTest {
    ...
    class CareerLevelManagementTests {
        ...
        void createCareerLevel_shouldSuccess() {
            ...
            when(careerLevelRepository.save(any(CareerLevel.class))).thenAnswer(invocation -> {
    ...
    class QueryCareerLevelTests {
        ...
        void listCareerLevels_shouldSuccess() {
            ...
            when(careerLevelRepository.page(any(Page.class), any(LambdaQueryWrapper.class))).thenReturn(page);
    ...
    class PromotionApplicationTests {
        ...
        void submitPromotionApplication_shouldFail_whenNotAvailable() {
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> promotionAppService.submitPromotionApplication(TEST_EMPLOYEE_ID, TEST_LEVEL_ID, "原因"));
        ...
        void listPromotionApplications_shouldReturnEmpty() {
            ...
            // When
            PageResult<PromotionApplicationDTO> result = promotionAppService.listPromotionApplications(query);
