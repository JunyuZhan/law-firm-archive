...
class LawRegulationAppServiceTest {
    ...
    @Mock
    private LawCategoryRepository lawCategoryRepository;

    @Mock
    private LawCategoryMapper lawCategoryMapper;

    @Mock
    private LawRegulationRepository lawRegulationRepository;
    ...
    @InjectMocks
    private LawRegulationAppService regulationAppService;
    ...
    class QueryCategoryTreeTests {
        ...
        void getCategoryTree_shouldSuccess() {
            // Given
            LawCategory category1 = LawCategory.builder()
                    .id(1L)
                    .name("分类1")
                    .parentId(0L)
                    .level(1)
            ...
            LawCategory category2 = LawCategory.builder()
                    .id(2L)
                    .name("分类2")
                    .parentId(1L)
                    .level(2)
            ...
            when(lawCategoryMapper.selectAllCategories())
    ...
    class QueryRegulationTests {
        ...
        void listRegulations_shouldSuccess() {
            ...
            Page<LawRegulation> pageResult = page;
            when(lawRegulationMapper.selectRegulationPage(any(Page.class), any(), any(), any()))
                    .thenReturn(pageResult);

            LawCategory category = LawCategory.builder()
                    .id(TEST_CATEGORY_ID)
                    .name("测试分类")
                    .build();
            when(lawCategoryRepository.getById(TEST_CATEGORY_ID)).thenReturn(category);
            when(knowledgeCollectionMapper.countByUserAndTarget(eq(TEST_USER_ID), eq(KnowledgeCollection.TYPE_LAW), eq(TEST_REGULATION_ID)))
                    .thenReturn(0);
    ...
    class CreateRegulationTests {
        ...
        void createRegulation_shouldSuccess() {
            ...
            when(lawRegulationRepository.save(any(LawRegulation.class))).thenAnswer(invocation -> {
        ...
        void createRegulation_shouldFail_whenTitleEmpty() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> regulationAppService.createRegulation(command));
    ...
    class UncollectRegulationTests {
        ...
        void uncollectRegulation_shouldSuccess() {
            // Given
            when(knowledgeCollectionMapper.deleteByUserAndTarget(eq(TEST_USER_ID), eq(KnowledgeCollection.TYPE_LAW), eq(TEST_REGULATION_ID)))
                    .thenReturn(1);
