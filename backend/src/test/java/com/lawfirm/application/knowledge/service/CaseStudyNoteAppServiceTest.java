...
class CaseStudyNoteAppServiceTest {
    ...
    @Mock
    private CaseStudyNoteRepository noteRepository;

    @Mock
    private CaseStudyNoteMapper noteMapper;
    ...
    @InjectMocks
    private CaseStudyNoteAppService noteAppService;
    ...
    class SaveNoteTests {
        ...
        void saveNote_shouldSuccess_whenCreateNew() {
            ...
            when(noteRepository.save(any(CaseStudyNote.class))).thenAnswer(invocation -> {
        ...
        void saveNote_shouldSuccess_whenUpdateExisting() {
            ...
            CaseStudyNote existingNote = CaseStudyNote.builder()
                    .id(TEST_NOTE_ID)
                    .caseId(TEST_CASE_ID)
                    .userId(TEST_USER_ID)
                    .noteContent("旧内容")
    ...
    class QueryNoteTests {
        ...
        void getMyNote_shouldSuccess() {
            // Given
            CaseStudyNote note = CaseStudyNote.builder()
                    .id(TEST_NOTE_ID)
                    .caseId(TEST_CASE_ID)
                    .userId(TEST_USER_ID)
                    .noteContent("笔记内容")
        ...
        void getCaseNotes_shouldSuccess() {
            // Given
            CaseStudyNote note1 = CaseStudyNote.builder()
                    .id(TEST_NOTE_ID)
                    .caseId(TEST_CASE_ID)
                    .userId(TEST_USER_ID)
                    .noteContent("笔记1")
            ...
            CaseStudyNote note2 = CaseStudyNote.builder()
                    .id(300L)
                    .caseId(TEST_CASE_ID)
