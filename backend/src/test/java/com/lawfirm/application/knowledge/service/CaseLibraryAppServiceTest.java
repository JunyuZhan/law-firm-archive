...
class CaseLibraryAppServiceTest {
    ...
    @InjectMocks
    private CaseLibraryAppService caseLibraryAppService;
    ...
    class CreateCaseTests {
        ...
        void createCase_EmptyTitle() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> caseLibraryAppService.createCase(command));
    ...
    class GetCaseTests {
        ...
        void getCaseById_NotFound() {
            ...
            // When & Then
            assertThrows(BusinessException.class,
                    () -> caseLibraryAppService.getCaseById(999L));
        }
    }
    ...
    class UpdateCaseTests {
        ...
        void updateCase_Success() {
            // Given
            CaseLibrary existingCase = CaseLibrary.builder()
                    .id(1L)
                    .title("原标题")
    ...
    class CollectCaseTests {
        ...
        void collectCase_CaseNotFound() {
            ...
            // When & Then
            assertThrows(BusinessException.class,
                    () -> caseLibraryAppService.collectCase(999L));
        }
    }
    ...
    class UncollectCaseTests {
        ...
        void uncollectCase_Success() {
            // Given
            when(knowledgeCollectionMapper.deleteByUserAndTarget(eq(1L), eq(KnowledgeCollection.TYPE_CASE), eq(1L)))
                    .thenReturn(1);
            ...
            // Then
            verify(knowledgeCollectionMapper).deleteByUserAndTarget(1L, KnowledgeCollection.TYPE_CASE, 1L);
    ...
    class DeleteCaseTests {
        ...
        void deleteCase_NotFound() {
            ...
            // When & Then
            assertThrows(BusinessException.class,
                    () -> caseLibraryAppService.deleteCase(999L));
        }
    }
}
