...
class QualityCheckStandardAppServiceTest {
    ...
    @Mock
    private QualityCheckStandardRepository standardRepository;

    @Mock
    private QualityCheckStandardMapper standardMapper;

    @InjectMocks
    private QualityCheckStandardAppService standardAppService;
    ...
    class QueryStandardTests {
        ...
        void getEnabledStandards_shouldSuccess() {
            ...
            when(standardMapper.selectEnabledStandards())
        ...
        void getStandardsByCategory_shouldSuccess() {
            ...
            // When
            List<QualityCheckStandardDTO> result = standardAppService.getStandardsByCategory(QualityCheckStandard.CATEGORY_CONTRACT);
    ...
    class CreateStandardTests {
        ...
        void createStandard_shouldSuccess() {
            ...
            when(standardRepository.save(any(QualityCheckStandard.class))).thenAnswer(invocation -> {
        ...
        void createStandard_shouldFail_whenNameEmpty() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> standardAppService.createStandard(command));
        ...
        void createStandard_shouldUseDefaults() {
            ...
            // Then
            assertThat(result).isNotNull();
            verify(standardRepository).save(argThat(standard ->
