...
class QualityIssueAppServiceTest {
  ...
  @Mock private QualityIssueRepository issueRepository;
  ...
  @InjectMocks private QualityIssueAppService issueAppService;
  ...
  class CreateIssueTests {
    ...
    void createIssue_shouldSuccess() {
      ...
      when(issueRepository.save(any(QualityIssue.class)))
          .thenAnswer(
              invocation -> {
    ...
    void createIssue_shouldUseDefaultPriority() {
      ...
      verify(issueRepository)
          .save(argThat(issue -> QualityIssue.PRIORITY_MEDIUM.equals(issue.getPriority())));
    }
  ...
  class UpdateIssueStatusTests {
    ...
    void updateIssueStatus_shouldSuccess_whenResolved() {
      ...
      // When
      QualityIssueDTO result =
          issueAppService.updateIssueStatus(TEST_ISSUE_ID, QualityIssue.STATUS_RESOLVED, "已解决");
    ...
    void updateIssueStatus_shouldSuccess_whenInProgress() {
      ...
      // When
      QualityIssueDTO result =
          issueAppService.updateIssueStatus(TEST_ISSUE_ID, QualityIssue.STATUS_IN_PROGRESS, null);
    ...
    void updateIssueStatus_shouldSuccess_whenClosed() {
      ...
      // When
      QualityIssueDTO result =
          issueAppService.updateIssueStatus(TEST_ISSUE_ID, QualityIssue.STATUS_CLOSED, null);
  ...
  class QueryIssueTests {
    ...
    void getIssuesByMatterId_shouldSuccess() {
      // Given
      QualityIssue issue =
          QualityIssue.builder().id(TEST_ISSUE_ID).matterId(TEST_MATTER_ID).build();
