...
class ArticleCommentAppServiceTest {
    ...
    @InjectMocks
    private ArticleCommentAppService commentAppService;
    ...
    class CreateCommentTests {
        ...
        void createComment_shouldSuccess_whenReply() {
            ...
            ArticleComment parentComment = ArticleComment.builder()
        ...
        void createComment_shouldFail_whenParentCommentNotExists() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> commentAppService.createComment(command));
    ...
    class QueryCommentTests {
        ...
        void getArticleComments_shouldSuccess() {
            // Given
            ArticleComment topComment = ArticleComment.builder()
                    .id(TEST_COMMENT_ID)
                    .articleId(TEST_ARTICLE_ID)
                    .userId(TEST_USER_ID)
                    .content("顶级评论")
            ...
            ArticleComment replyComment = ArticleComment.builder()
                    .id(PARENT_COMMENT_ID)
                    .articleId(TEST_ARTICLE_ID)
            ...
            when(commentMapper.selectByParentId(TEST_COMMENT_ID))
