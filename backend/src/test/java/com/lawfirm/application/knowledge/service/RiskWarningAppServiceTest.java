...
class RiskWarningAppServiceTest {
  ...
  @Mock private RiskWarningRepository warningRepository;

  @Mock private RiskWarningMapper warningMapper;

  @Mock private MatterRepository matterRepository;

  @Mock private UserRepository userRepository;

  @InjectMocks private RiskWarningAppService warningAppService;
  ...
  class CreateWarningTests {
    ...
    void createWarning_shouldSuccess() {
      ...
      when(warningRepository.save(any(RiskWarning.class)))
          .thenAnswer(
              invocation -> {
  ...
  class QueryWarningTests {
    ...
    void getWarningsByMatterId_shouldSuccess() {
      // Given
      RiskWarning warning =
          RiskWarning.builder().id(TEST_WARNING_ID).matterId(TEST_MATTER_ID).build();
