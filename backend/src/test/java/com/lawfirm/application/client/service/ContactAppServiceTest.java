...
/** ContactAppService 单元测试 测试联系人管理服务的核心功能 */
...
class ContactAppServiceTest {
  ...
  @InjectMocks private ContactAppService contactAppService;
  ...
  class UpdateContactTests {
    ...
    void updateContact_shouldClearOtherPrimary() {
      // Given
      Contact contact =
          Contact.builder().id(TEST_CONTACT_ID).clientId(TEST_CLIENT_ID).isPrimary(false).build();
  ...
  class DeleteContactTests {
    ...
    void deleteContact_shouldSuccess() {
      // Given
      Contact contact = Contact.builder().id(TEST_CONTACT_ID).contactName("张三").build();
  ...
  class QueryContactTests {
    ...
    void listContacts_shouldSuccess() {
      ...
      Contact contact =
          Contact.builder().id(TEST_CONTACT_ID).clientId(TEST_CLIENT_ID).contactName("张三").build();
