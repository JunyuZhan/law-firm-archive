...
class MatterTimelineAppServiceTest {
    ...
    @Mock
    private LetterApplicationMapper letterApplicationMapper;

    @Mock
    private UserRepository userRepository;

    @InjectMocks
    private MatterTimelineAppService matterTimelineAppService;
    ...
    class GetMatterTimelineTests {
        ...
        void getMatterTimeline_shouldSuccess() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                when(matterAppService.getAccessibleMatterIds("ALL", TEST_USER_ID, TEST_DEPT_ID)).thenReturn(null);
        ...
        void getMatterTimeline_shouldIncludeTaskCompleted() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                // Then
                assertThat(result).isNotNull();
                boolean hasTaskEvent = result.stream()
                        .anyMatch(e -> "TASK_COMPLETED".equals(e.getEventType()));
        ...
        void getMatterTimeline_shouldIncludeContractSigned() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                // Then
                assertThat(result).isNotNull();
                boolean hasContractEvent = result.stream()
                        .anyMatch(e -> "CONTRACT_SIGNED".equals(e.getEventType()));
        ...
        void getMatterTimeline_shouldIncludePaymentReceived() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                // Then
                assertThat(result).isNotNull();
                boolean hasPaymentEvent = result.stream()
                        .anyMatch(e -> "PAYMENT_RECEIVED".equals(e.getEventType()));
