...
class TaskCommentAppServiceTest {
    ...
    @InjectMocks
    private TaskCommentAppService taskCommentAppService;
    ...
    class GetTaskCommentsTests {
        ...
        void getTaskComments_shouldFail_whenTaskNotExists() {
            ...
            assertThrows(BusinessException.class,
                    () -> taskCommentAppService.getTaskComments(TEST_TASK_ID));
        }
    }
    ...
    class DeleteCommentTests {
        ...
        void deleteComment_shouldSuccess() {
            ...
            when(taskCommentRepository.getByIdOrThrow(eq(TEST_COMMENT_ID), anyString())).thenReturn(comment);
