...
class TimesheetAppServiceTest {
    ...
    @Mock
    private com.lawfirm.infrastructure.persistence.mapper.DepartmentMapper departmentMapper;

    @Mock
    private com.lawfirm.domain.system.repository.UserRepository userRepository;
    ...
    class UpdateTimesheetTests {
        ...
        void updateTimesheet_shouldSuccess() {
            ...
            // When
            TimesheetDTO result = timesheetAppService.updateTimesheet(
    ...
    class SubmitTimesheetTests {
        ...
        void submitTimesheet_shouldFail_whenAlreadySubmitted() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> timesheetAppService.submitTimesheet(1L));
            assertThat(exception.getMessage()).contains("草稿状态");
        }
        ...
        void batchSubmit_shouldSuccess() {
            ...
            // When
            TimesheetAppService.BatchSubmitResult result = timesheetAppService.batchSubmit(Arrays.asList(1L, 2L));
    ...
    class ApproveTimesheetTests {
        ...
        void approveTimesheet_shouldFail_whenDraft() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> timesheetAppService.approveTimesheet(1L, ""));
    ...
    class QueryTimesheetTests {
        ...
        void listTimesheets_shouldSuccess() {
            ...
            when(timesheetMapper.selectTimesheetPage(any(Page.class), any(), any(), any(), any(), any(), any(), any(), isNull()))
                    .thenReturn(page);
