...
class AnnouncementAppServiceTest {
  ...
  @InjectMocks private AnnouncementAppService announcementAppService;
  ...
  class QueryAnnouncementTests {
    ...
    void listAnnouncements_shouldSuccess() {
      ...
      when(announcementMapper.selectAnnouncementPage(
              ArgumentMatchers.<Page<Announcement>>any(), any(), any()))
          .thenReturn(page);
      ...
      // When
      PageResult<AnnouncementDTO> result =
          announcementAppService.listAnnouncements(query, null, null);
  ...
  class CreateAnnouncementTests {
    ...
    void createAnnouncement_shouldFail_whenTitleEmpty() {
      ...
      BusinessException exception =
          assertThrows(
              BusinessException.class, () -> announcementAppService.createAnnouncement(command));
