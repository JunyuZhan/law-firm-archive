...
class AuthServiceTest {
    ...
    @Mock
    private com.lawfirm.application.system.util.UserAgentParser userAgentParser;
    ...
    void setUp() {
        ...
        // Mock LoginUser
        mockLoginUser = LoginUser.builder()
                .userId(1L)
                .username("testuser")
                .realName("测试用户")
                .roles(new HashSet<>())
    ...
    class LoginTests {
        ...
        void login_TooManyFailures_ShouldLockAccount() {
            ...
            when(loginLogService.shouldLockAccount("testuser"))
                    .thenReturn(true);
        ...
        void login_IpRateLimited_ShouldThrowException() {
            ...
            when(loginLogService.shouldLockAccount("testuser"))
                    .thenReturn(false);
            when(valueOperations.get("login:ip:127.0.0.1"))
                    .thenReturn(15);  // 超过10次限制
        ...
        void login_Success() {
            ...
            AuthService.LoginResult result = authService.login(
                    "testuser", "password", "127.0.0.1", "Mozilla/5.0");
            ...
            // 验证登录成功日志被记录
            verify(loginLogService).recordLoginSuccess(anyLong(), eq("testuser"), anyString(), anyString());
        }
    }
