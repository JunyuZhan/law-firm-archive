...
class ArchiveLocationAppServiceTest {
    ...
    @Mock
    private ArchiveLocationRepository locationRepository;

    @InjectMocks
    private ArchiveLocationAppService locationAppService;
    ...
    class QueryLocationTests {
        ...
        void listLocations_shouldSuccess() {
            // Given
            ArchiveLocation location1 = ArchiveLocation.builder()
                    .id(TEST_LOCATION_ID)
            ...
            ArchiveLocation location2 = ArchiveLocation.builder()
                    .id(200L)
            ...
            when(locationRepository.list(wrapper))
    ...
    class CreateLocationTests {
        ...
        void createLocation_shouldSuccess() {
            ...
            when(locationRepository.count(any(LambdaQueryWrapper.class))).thenReturn(0L);
            when(locationRepository.save(any(ArchiveLocation.class))).thenAnswer(invocation -> {
        ...
        void createLocation_shouldFail_whenCodeExists() {
            ...
            when(locationRepository.count(any(LambdaQueryWrapper.class))).thenReturn(1L);

            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> locationAppService.createLocation(dto));
        ...
        void createLocation_shouldUseDefaultStatus() {
            ...
            verify(locationRepository).save(argThat(location ->
                    "AVAILABLE".equals(location.getStatus())
            ));
        }
    }
    ...
    class UpdateLocationTests {
        ...
        void updateLocation_shouldFail_whenLocationNotExists() {
            ...
            assertThrows(BusinessException.class,
                    () -> locationAppService.updateLocation(TEST_LOCATION_ID, dto));
        }
    }
