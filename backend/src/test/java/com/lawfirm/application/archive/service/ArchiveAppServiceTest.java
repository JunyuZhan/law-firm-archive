...
class ArchiveAppServiceTest {
    ...
    @Mock
    private ArchiveDataCollectorService dataCollectorService;
    
    @Mock
    private DossierCoverGenerator coverGenerator;
    ...
    class CreateArchiveTests {
        ...
        void createArchive_Success() throws Exception {
            ...
            when(minioService.uploadBytes(any(), anyString(), anyString())).thenReturn("http://minio/cover.pdf");
        ...
        void createArchive_InvalidMatterStatus() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> archiveAppService.createArchive(command));
    ...
    class RetentionPeriodTests {
        ...
        void setRetentionPeriod_InvalidStatus() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> archiveAppService.setRetentionPeriod(1L, "10_YEARS"));
