...
class ApprovalAppServiceTest {
    ...
    @Mock
    private com.lawfirm.application.finance.service.ExpenseAppService expenseAppService;

    @Mock
    private com.lawfirm.application.hr.service.RegularizationAppService regularizationAppService;

    @Mock
    private com.lawfirm.application.hr.service.ResignationAppService resignationAppService;
    ...
    class QueryApprovalTests {
        ...
        void listApprovals_shouldSuccess() {
            ...
            when(approvalMapper.selectApprovalPageWithPermission(any(), any(), any(), any(), eq(TEST_USER_ID), anyBoolean(), anyInt(), anyInt()))
                    .thenReturn(Collections.singletonList(approval));
            when(approvalMapper.countApprovalWithPermission(any(), any(), any(), any(), eq(TEST_USER_ID), anyBoolean()))
                    .thenReturn(1L);
        ...
        void listApprovals_shouldReturnEmpty_whenException() {
            ...
            when(approvalMapper.selectApprovalPageWithPermission(any(), any(), any(), any(), any(), anyBoolean(), anyInt(), anyInt()))
        ...
        void getApprovalById_shouldFail_whenNoPermission() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> approvalAppService.getApprovalById(1L));
    ...
    class BatchApproveTests {
        ...
        void batchApprove_shouldSuccess() {
            ...
            ApprovalAppService.BatchApproveResult result = approvalAppService.batchApprove(
                    Arrays.asList(1L, 2L), ApprovalStatus.APPROVED, "批量通过");
        ...
        void batchApprove_shouldFail_whenOneInvalid() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> approvalAppService.batchApprove(Arrays.asList(1L, 2L), ApprovalStatus.APPROVED, ""));
            assertThat(exception.getMessage()).contains("无权审批");
        }
        ...
        void batchApprove_shouldFail_whenEmptyList() {
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> approvalAppService.batchApprove(Collections.emptyList(), ApprovalStatus.APPROVED, ""));
