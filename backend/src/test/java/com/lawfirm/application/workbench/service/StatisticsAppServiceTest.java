...
/** StatisticsAppService 单元测试 测试统计服务的核心功能 */
...
class StatisticsAppServiceTest {
  ...
  @InjectMocks private StatisticsAppService statisticsAppService;
  ...
  class GetRevenueStatsTests {
    ...
    void getRevenueStats_shouldReturnStats() {
      ...
      lenient()
          .when(statisticsMapper.sumTotalRevenue(isNull()))
          .thenReturn(BigDecimal.valueOf(1000000));
      lenient()
          .when(statisticsMapper.sumMonthlyRevenue(isNull()))
          .thenReturn(BigDecimal.valueOf(100000));
      lenient()
          .when(statisticsMapper.sumYearlyRevenue(isNull()))
          .thenReturn(BigDecimal.valueOf(500000));
      lenient()
          .when(statisticsMapper.sumPendingRevenue(isNull()))
          .thenReturn(BigDecimal.valueOf(200000));
      lenient()
          .when(statisticsMapper.getRevenueTrends(isNull()))
    ...
    void getRevenueStats_shouldReturnTrends() {
      ...
      assertThat(result.getTrends().get(0).getAmount())
  ...
  class GetMatterStatsTests {
    ...
    void getMatterStats_shouldReturnAll_whenAllScope() {
      ...
      com.baomidou.mybatisplus.extension.conditions.query.LambdaQueryChainWrapper<
              com.lawfirm.domain.matter.entity.Matter>
          chainWrapper =
              mock(
                  com.baomidou.mybatisplus.extension.conditions.query.LambdaQueryChainWrapper
                      .class);
      ...
      lenient()
          .when(statisticsMapper.countMattersByStatus(isNull()))
          .thenReturn(Collections.emptyList());
      lenient()
          .when(statisticsMapper.countMattersByType(isNull()))
          .thenReturn(Collections.emptyList());
    ...
    void getMatterStats_shouldReturnEmpty_whenException() {
      // Given
      when(matterRepository.lambdaQuery()).thenThrow(new RuntimeException("Database error"));
  ...
  class GetClientStatsTests {
    ...
    void getClientStats_shouldReturnStats() {
      ...
      lenient()
          .when(statisticsMapper.countClientsByType(isNull()))
          .thenReturn(Collections.emptyList());
  ...
  class GetLawyerPerformanceRankingTests {
    ...
    void getLawyerPerformanceRanking_shouldReturnRanking() {
      ...
      lenient()
          .when(statisticsMapper.getLawyerPerformanceRanking(anyInt(), isNull()))
          .thenReturn(rankings);
      lenient()
          .when(commissionRepository.sumCommissionByUserIds(anyList()))
          .thenReturn(Map.of(1L, BigDecimal.valueOf(10000), 2L, BigDecimal.valueOf(8000)));

      // When
      List<StatisticsDTO.LawyerPerformance> result =
          statisticsAppService.getLawyerPerformanceRanking(10);
