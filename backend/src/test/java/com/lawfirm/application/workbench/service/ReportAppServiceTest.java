...
class ReportAppServiceTest {
    ...
    class GetAvailableReportsTests {
        ...
        void getAvailableReports_shouldSuccess() {
            ...
            // 验证包含常见的报表类型
            boolean hasRevenueReport = result.stream()
                    .anyMatch(r -> "REVENUE".equals(r.getType()));
    ...
    class QueryReportTests {
        ...
        void listReports_shouldSuccess() {
            ...
            when(reportMapper.selectReportPage(any(Page.class), any(), any(), any()))
                    .thenReturn(page);
        ...
        void getReportById_shouldFail_whenNoPermission() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                BusinessException exception = assertThrows(BusinessException.class,
                        () -> reportAppService.getReportById(TEST_REPORT_ID));
