...
class GoOutAppServiceTest {
    ...
    @Mock
    private GoOutRecordRepository goOutRepository;

    @Mock
    private GoOutRecordMapper goOutMapper;

    @Mock
    private UserRepository userRepository;

    @InjectMocks
    private GoOutAppService goOutAppService;
    ...
    class RegisterGoOutTests {
        ...
        void registerGoOut_shouldFail_whenOutTimeAfterReturnTime() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> goOutAppService.registerGoOut(command));
    ...
    class RegisterReturnTests {
        ...
        void registerReturn_shouldFail_whenNotOut() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> goOutAppService.registerReturn(TEST_RECORD_ID));
        ...
        void registerReturn_shouldFail_whenNotOwner() {
            ...
            securityUtilsMock.when(() -> SecurityUtils.hasAnyRole(anyString(), anyString())).thenReturn(false);
        ...
        void registerReturn_shouldSuccess_whenAdmin() {
            ...
            securityUtilsMock.when(() -> SecurityUtils.hasAnyRole("ADMIN", "HR_MANAGER")).thenReturn(true);
    ...
    class QueryRecordsTests {
        ...
        void getMyRecords_shouldSuccess() {
            ...
            when(goOutMapper.selectByUserId(TEST_USER_ID))
