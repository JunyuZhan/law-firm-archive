...
class PurchaseAppServiceTest {
    ...
    @Mock
    private PurchaseReceiveRepository receiveRepository;
    ...
    class CreateRequestTests {
        ...
        void createRequest_shouldSuccess() {
            ...
            PurchaseRequest savedRequest = PurchaseRequest.builder()
                    .id(TEST_REQUEST_ID)
                    .requestNo("PR2024001")
                    .build();

            when(requestRepository.save(any(PurchaseRequest.class))).thenAnswer(invocation -> {
        ...
        void createRequest_shouldCalculateAmount() {
            ...
            verify(requestRepository).save(argThat(req -> 
                    req.getEstimatedAmount().compareTo(new BigDecimal("110.00")) == 0));
        }
    }
    ...
    class ReceiveItemTests {
        ...
        void receiveItem_shouldFail_whenQuantityExceeds() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> purchaseAppService.receiveItem(command));
    ...
    class QueryRequestTests {
        ...
        void listRequests_shouldSuccess() {
            ...
            when(requestRepository.findPage(any(Page.class), any(), any(), any(), any(), any()))
                    .thenReturn(page);
            when(userRepository.listByIds(anyList())).thenReturn(Collections.emptyList());

            // When
            PageResult<PurchaseRequestDTO> result = purchaseAppService.listRequests(
        ...
        void getRequestById_shouldSuccess() {
            ...
            PurchaseRequest requestWithId = PurchaseRequest.builder()
                    .id(TEST_REQUEST_ID)
                    .requestNo("PR2024001")
                    .title("采购申请1")
                    .build();
        ...
        void getRequestById_shouldFail_whenNotFound() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> purchaseAppService.getRequestById(TEST_REQUEST_ID));
