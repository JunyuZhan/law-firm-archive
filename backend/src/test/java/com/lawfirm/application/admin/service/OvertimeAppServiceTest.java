...
class OvertimeAppServiceTest {
    ...
    @Mock
    private OvertimeApplicationRepository overtimeRepository;

    @Mock
    private OvertimeApplicationMapper overtimeMapper;
    ...
    class ApplyOvertimeTests {
        ...
        void applyOvertime_shouldSuccess() {
            ...
            when(overtimeRepository.save(any(OvertimeApplication.class))).thenAnswer(invocation -> {
        ...
        void applyOvertime_shouldFail_whenHoursTooLong() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> overtimeAppService.applyOvertime(command));
    ...
    class ApproveOvertimeTests {
        ...
        void approveOvertime_shouldSuccess_whenApproved() {
            ...
            when(overtimeRepository.getByIdOrThrow(eq(TEST_APPLICATION_ID), anyString())).thenReturn(application);
            when(overtimeRepository.updateById(any(OvertimeApplication.class))).thenReturn(true);

            // When
            OvertimeApplicationDTO result = overtimeAppService.approveOvertime(TEST_APPLICATION_ID, true, "同意");
        ...
        void approveOvertime_shouldSuccess_whenRejected() {
            ...
            // When
            OvertimeApplicationDTO result = overtimeAppService.approveOvertime(TEST_APPLICATION_ID, false, "不同意");
    ...
    class QueryOvertimeTests {
        ...
        void getApplicationsByDateRange_shouldSuccess() {
            ...
            // When
            List<OvertimeApplicationDTO> result = overtimeAppService.getApplicationsByDateRange(startDate, endDate);
