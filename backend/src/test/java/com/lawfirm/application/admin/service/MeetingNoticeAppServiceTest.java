...
/** MeetingNoticeAppService 单元测试 测试会议通知服务的核心功能 */
...
class MeetingNoticeAppServiceTest {
  ...
  @InjectMocks private MeetingNoticeAppService meetingNoticeAppService;
