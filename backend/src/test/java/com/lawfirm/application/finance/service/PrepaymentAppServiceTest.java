...
class PrepaymentAppServiceTest {
    ...
    @Mock
    private PrepaymentUsageRepository usageRepository;

    @Mock
    private PrepaymentMapper prepaymentMapper;

    @Mock
    private PrepaymentUsageMapper usageMapper;
    ...
    @InjectMocks
    private PrepaymentAppService prepaymentAppService;
    ...
    class ConfirmPrepaymentTests {
        ...
        void confirmPrepayment_shouldSuccess() {
            ...
            when(prepaymentRepository.getByIdOrThrow(eq(TEST_PREPAYMENT_ID), anyString())).thenReturn(prepayment);
    ...
    class UsePrepaymentTests {
        ...
        void usePrepayment_shouldSuccess() {
            ...
            when(usageRepository.save(any(PrepaymentUsage.class))).thenAnswer(invocation -> {
    ...
    class QueryPrepaymentTests {
        ...
        void getPrepaymentById_shouldSuccess() {
            ...
            when(prepaymentRepository.getByIdOrThrow(eq(TEST_PREPAYMENT_ID), anyString())).thenReturn(prepayment);
            when(usageRepository.findByPrepaymentId(TEST_PREPAYMENT_ID)).thenReturn(Collections.emptyList());
