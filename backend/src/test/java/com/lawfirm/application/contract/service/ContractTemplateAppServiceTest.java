...
class ContractTemplateAppServiceTest {
  ...
  @InjectMocks private ContractTemplateAppService templateAppService;
  ...
  class QueryTemplateTests {
    ...
    void getActiveTemplates_shouldSuccess() {
      ...
      when(contractTemplateRepository.findActiveTemplates()).thenReturn(List.of(template));
    ...
    void getAllTemplates_shouldSuccess() {
      // Given
      ContractTemplate template = ContractTemplate.builder().name("测试模板").status("ACTIVE").build();
      template.setId(TEST_TEMPLATE_ID);

      when(contractTemplateRepository.findAllTemplates()).thenReturn(List.of(template));
    ...
    void getTemplatesByType_shouldSuccess() {
      // Given
      ContractTemplate template =
          ContractTemplate.builder().name("民事代理模板").templateType("CIVIL_PROXY").build();
      template.setId(TEST_TEMPLATE_ID);
    ...
    void getTemplatesByType_shouldFail_whenTypeEmpty() {
      ...
      BusinessException exception =
          assertThrows(BusinessException.class, () -> templateAppService.getTemplatesByType(""));
  ...
  class CreateTemplateTests {
    ...
    void createTemplate_shouldSuccess() {
      ...
      when(contractTemplateRepository.save(any(ContractTemplate.class)))
          .thenAnswer(
              invocation -> {
    ...
    void createTemplate_shouldFail_whenNoPermission() {
      ...
      // When & Then
      BusinessException exception =
          assertThrows(BusinessException.class, () -> templateAppService.createTemplate(command));
  ...
  class DeleteTemplateTests {
    ...
    void deleteTemplate_shouldFail_whenInUse() {
      // Given
      ContractTemplate template = ContractTemplate.builder().name("测试模板").build();
      template.setId(TEST_TEMPLATE_ID);
      ...
      BusinessException exception =
          assertThrows(
              BusinessException.class, () -> templateAppService.deleteTemplate(TEST_TEMPLATE_ID));
