...
/**
 * SealApplicationAppService 单元测试
 * 测试用印申请服务的核心功能
 */
...
class SealApplicationAppServiceTest {
    ...
    private static final Long TEST_KEEPER_ID = 300L;
    ...
    @Mock
    private SealApplicationMapper applicationMapper;
    ...
    @InjectMocks
    private SealApplicationAppService sealApplicationAppService;
    ...
    class CreateApplicationTests {
        ...
        void createApplication_shouldSuccess() {
            ...
            when(applicationRepository.count(any(LambdaQueryWrapper.class))).thenReturn(0L);
            when(applicationRepository.save(any(SealApplication.class))).thenAnswer(invocation -> {
            ...
            lenient().when(approvalService.createApproval(anyString(), anyLong(), anyString(), 
                    anyString(), anyLong(), anyString(), anyString(), any())).thenReturn(null);
        ...
        void createApplication_shouldFail_whenSealInactive() {
            ...
            BusinessException exception = assertThrows(BusinessException.class,
                    () -> sealApplicationAppService.createApplication(command));
    ...
    class RegisterUsageTests {
        ...
        void registerUsage_shouldSuccess() {
            ...
            // When
            SealApplicationDTO result = sealApplicationAppService.registerUsage(TEST_APPLICATION_ID, "已用印");
    ...
    class QueryApplicationTests {
        ...
        void listApplications_shouldSuccess() {
            ...
            when(applicationMapper.selectApplicationPage(any(Page.class), any(), any(), any(), any(), any())).thenReturn(page);
    ...
    class KeeperPermissionTests {
        ...
        void isAnySealKeeper_shouldReturnTrue() {
            // Given
            when(sealRepository.count(any(LambdaQueryWrapper.class))).thenReturn(1L);
