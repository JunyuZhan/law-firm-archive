...
class MoneyUtilsTest {
  ...
  @ParameterizedTest
  @CsvSource({"100, 壹佰元整", "100.5, 壹佰元伍角整", "100.4, 壹佰元肆角整", "100.6, 壹佰元陆角整"})
  ...
  @ParameterizedTest
  @CsvSource({"0, 零元整", "1, 壹元整", "100, 壹佰元整", "10000, 壹万元整", "123456, 壹拾贰万叁仟肆佰伍拾陆元整"})
  ...
  @ParameterizedTest
  @CsvSource({"100.4, 壹佰元整", "100.5, 壹佰零壹元整", "100.49, 壹佰元整", "100.50, 壹佰零壹元整"})
