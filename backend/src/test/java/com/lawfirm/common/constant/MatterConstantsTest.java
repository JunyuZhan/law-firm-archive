...
class MatterConstantsTest {
    ...
    void shouldContainAll7MatterStatuses() {
        ...
        assertThat(MatterConstants.MATTER_STATUS_NAME_MAP).containsKeys(
            "DRAFT", "PENDING", "ACTIVE", "SUSPENDED",
            "PENDING_CLOSE", "CLOSED", "ARCHIVED"
        );
    }
    ...
    void shouldHandleSpecialCharacters() {
        assertThat(MatterConstants.getMatterTypeName("TYPE_WITH_UNDERSCORE")).isEqualTo("TYPE_WITH_UNDERSCORE");
