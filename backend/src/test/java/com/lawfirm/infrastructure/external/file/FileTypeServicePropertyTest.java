 ...
 * 文件类型服务属性测试
 *
 * <p>Feature: evidence-management Property 1: 文件类型验证 Validates: Requirements 1.1, 1.2, 1.8
 *
 * <p>测试文件类型识别和验证逻辑的正确性
 */
class FileTypeServicePropertyTest {
  ...
  @Property(tries = 100)
  void filesWithoutExtensionShouldBeOther(@ForAll("randomFileBaseName") String baseName) {
  ...
  Arbitrary<String> unsupportedExtensions() {
    return Arbitraries.of(
        "exe", "bat", "sh", "dll", "so", "zip", "rar", "7z", "tar", "gz", "txt", "csv", "json",
        "xml", "html", "css", "js", "java", "py", "rb");
  }
  ...
  Arbitrary<String> supportedExtensionsWithCase() {
    Set<String> allSupported =
        Set.of(
            "jpg", "JPG", "Jpg", "jpeg", "JPEG", "png", "PNG", "gif", "GIF", "pdf", "PDF", "doc",
            "DOC", "docx", "DOCX", "mp3", "MP3", "wav", "WAV", "mp4", "MP4", "avi", "AVI");
