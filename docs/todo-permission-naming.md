...
### 阶段1：分析现状
- [ ] 1.1 统计后端使用 `system:` 前缀的权限码
- [ ] 1.2 统计后端使用 `:edit` 动词的权限码
- [ ] 1.3 统计 sys_menu 中需要修改的记录

### 阶段2：修改后端 Controller
- [ ] 2.1 修改使用 `system:` 前缀的 Controller
- [ ] 2.2 修改使用 `:edit` 动词的 Controller

### 阶段3：修改数据库初始化脚本
- [ ] 3.1 修改 20-init-data.sql 中的权限码
- [ ] 3.2 修改其他 SQL 脚本中的权限码
