...
| 优先级 | 任务 | 负责人 | 状态 |
|--------|------|--------|------|
| P0 | P1-001 工资权限检查 | | 待开始 |
| P0 | P1-002 合同变更同步 | | 待开始 |
| P1 | P2-004 客户冲突检查 | | 待开始 |
| P1 | P2-005 案由管理前端 | | 待开始 |
...
|--------|------|--------|------|
| P1 | P2-002 @提醒通知 | | 待开始 |
| P1 | P2-001 合同组件拆分 | | 待开始 |
| P2 | P2-003 定时报表通知 | | 待开始 |

### 持续进行

| 优先级 | 任务 | 负责人 | 状态 |
|--------|------|--------|------|
| P3 | P3-001 console.log清理 | | 待开始 |
| P3 | P3-002 定时器清理 | | 待开始 |
| P3 | P3-003 虚拟滚动 | | 待开始 |
| P3 | P3-004 佣金规则 | | 待开始 |
| P3 | P3-005 节假日集成 | | 待开始 |
| P3 | P3-006 企业微信集成 | | 待开始 |
