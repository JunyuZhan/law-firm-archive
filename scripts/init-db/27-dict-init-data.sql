...
SELECT setval('sys_dict_type_id_seq', GREATEST((SELECT MAX(id) FROM sys_dict_type), 50));
SELECT setval('sys_dict_item_id_seq', GREATEST((SELECT MAX(id) FROM sys_dict_item), 500));
