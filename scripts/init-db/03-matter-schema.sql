...
\restrict tPPGXdprkDZ1k5xiYvBOTmVuCidcif9meFr5Y8izDyrBfQjkEDy4p7RIe4dSzXO
...
CREATE TABLE public.matter_client (
    ...
    matter_id bigint NOT NULL,
    client_id bigint NOT NULL,
    client_role character varying(50) DEFAULT 'PLAINTIFF',
...
COMMENT ON COLUMN public.matter_client.is_primary IS '是否主要客户';
...
CREATE UNIQUE INDEX idx_matter_client_unique ON public.matter_client (matter_id, client_id) WHERE (deleted = false);
...
\unrestrict tPPGXdprkDZ1k5xiYvBOTmVuCidcif9meFr5Y8izDyrBfQjkEDy4p7RIe4dSzXO
