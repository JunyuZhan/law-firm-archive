...
\restrict qBpGxQXAPDXgwf2xRhTfecgyo6x8EEfF1IoGM52KIzQuVyPjXZJCuYMqiQTWaEi
...
--
-- Name: COLUMN finance_commission_rule.firm_retention_rate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.firm_retention_rate IS '律所留存比例';
...
COMMENT ON COLUMN public.finance_commission_rule.originator_rate IS '案源提成比例';


--
-- Name: COLUMN finance_commission_rule.tax_rate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.tax_rate IS '税费率';


--
-- Name: COLUMN finance_commission_rule.management_fee_rate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.management_fee_rate IS '管理费率';


--
-- Name: COLUMN finance_commission_rule.rate_tiers; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.rate_tiers IS '阶梯费率（JSON格式）';


--
-- Name: COLUMN finance_commission_rule.effective_date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.effective_date IS '生效日期';


--
-- Name: COLUMN finance_commission_rule.expiry_date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.finance_commission_rule.expiry_date IS '失效日期';
...
\unrestrict qBpGxQXAPDXgwf2xRhTfecgyo6x8EEfF1IoGM52KIzQuVyPjXZJCuYMqiQTWaEi
