    ...
    entries: [
      {
        ...
        tips: ['角色权限调整后，应重点复核借阅、日志与规则参数等敏感页面。']
      },
      {
        title: '站点与展示',
        route: '/system/setup',
        description: '维护系统名称、Logo、备案号与版权等登录页与侧栏展示内容。',
        roles: [ROLES.SYSTEM_ADMIN],
      ...
      },
      {
        title: '规则与运行参数',
        route: '/system/config',
        description: '维护档案号规则、保管期限、上传限制、借阅与水印、安全与通知、搜索分页及镜像升级检查等。',
        roles: [ROLES.SYSTEM_ADMIN],
        steps: ['先核对档案号规则与保管期限。', '再按需调整上传、借阅、安全与通知等参数。', '保存后刷新缓存并抽查关键业务流程。'],
      ...
      },
      {
        ...
        tips: ['恢复属于敏感操作，执行前应先确认恢复范围、备份可用性和业务影响。']
      },
      {
        title: '操作日志',
        route: '/system/logs',
        ...
        tips: ['审计核查时可优先关注借阅、删除、导出与运行参数变更。']
      },
      {
        title: '系统信息',
        route: '/system/info',
        description: '查看版本与依赖，并向镜像仓库检查是否存在可用更新。',
        roles: [ROLES.SYSTEM_ADMIN],
        steps: ['查看产品版本与构建信息。', '在「镜像仓库更新」中点击检查，读取仓库结果。', '查看依赖状态是否正常。'],
        tips: ['镜像仓库连接与比对参数在「规则与运行参数」中维护。']
      }
    ]
  }
]
