...
export function getPendingAmendments() {
  return requestClient.get<ContractAmendment[]>('/finance/contract-amendments/pending');
}
...
export function getAmendmentsByContractId(contractId: number) {
  return requestClient.get<ContractAmendment[]>(`/finance/contract-amendments/contract/${contractId}`);
}
...
export function syncAmendment(amendmentId: number, remark?: string) {
  return requestClient.post(`/finance/contract-amendments/${amendmentId}/sync`, null, {
    params: { remark },
  });
}
...
export function ignoreAmendment(amendmentId: number, remark: string) {
  return requestClient.post(`/finance/contract-amendments/${amendmentId}/ignore`, null, {
    params: { remark },
  });
}
