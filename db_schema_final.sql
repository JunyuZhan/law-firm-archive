...
\restrict 63gu8aaacxKAJaL77MK3UJORu0HNkyB4Esh5aTHwcDN6GjzUaDcE5rilgOaHdr4
...
--
-- Name: get_cause_name(character varying, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_cause_name(p_code character varying, p_type character varying DEFAULT 'CIVIL'::character varying) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_name VARCHAR;
...
--
-- Name: FUNCTION get_cause_name(p_code character varying, p_type character varying); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_cause_name(p_code character varying, p_type character varying) IS '根据案由代码获取案由名称';
...
--
-- Name: ai_monthly_bill; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ai_monthly_bill (
    ...
    user_cost numeric(10,4) DEFAULT 0,
    charge_ratio integer DEFAULT 100,
    deduction_status character varying(20) DEFAULT 'PENDING'::character varying,
    deduction_amount numeric(10,4),
...
--
-- Name: TABLE ai_monthly_bill; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_monthly_bill_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_monthly_bill_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_monthly_bill_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_monthly_bill_id_seq OWNED BY public.ai_monthly_bill.id;


--
-- Name: ai_pricing_config; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ai_pricing_config (
    ...
    prompt_price numeric(10,6) DEFAULT 0 NOT NULL,
    completion_price numeric(10,6) DEFAULT 0 NOT NULL,
    per_call_price numeric(10,4),
    pricing_mode character varying(20) DEFAULT 'TOKEN'::character varying,
...
--
-- Name: TABLE ai_pricing_config; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_pricing_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_pricing_config_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_pricing_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_pricing_config_id_seq OWNED BY public.ai_pricing_config.id;
...
CREATE TABLE public.ai_usage_log (
    ...
    prompt_price numeric(10,6) DEFAULT 0,
    completion_price numeric(10,6) DEFAULT 0,
    total_cost numeric(10,4) DEFAULT 0,
    user_cost numeric(10,4) DEFAULT 0,
    charge_ratio integer DEFAULT 100,
...
--
-- Name: COLUMN ai_usage_log.charge_ratio; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_user_quota; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ai_user_quota (
    ...
    monthly_cost_quota numeric(10,2),
...
--
-- Name: TABLE ai_user_quota; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_user_quota_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_user_quota_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_user_quota_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_user_quota_id_seq OWNED BY public.ai_user_quota.id;
...
CREATE TABLE public.archive (
    ...
    bucket_name character varying(50) DEFAULT 'law-firm'::character varying,
...
--
-- Name: COLUMN crm_client.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.client_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.contact_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact."position"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.department; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.mobile_phone; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.office_phone; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.email; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.wechat; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.is_primary; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crm_contact.relationship_note; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN doc_document.source_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN doc_document.source_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN doc_document.source_module; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.doc_template (
    ...
    case_type character varying(30) DEFAULT 'ALL'::character varying,
    file_name character varying(500) NOT NULL,
    file_path character varying(1000) NOT NULL,
    file_size bigint,
    variables text,
...
--
-- Name: COLUMN finance_contract.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_invoice.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_payment.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.prepayment_no; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.client_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.contract_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.matter_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.used_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.remaining_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment_usage.prepayment_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment_usage.fee_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment_usage.amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN finance_prepayment_usage.usage_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: matter_state_compensation_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.matter_state_compensation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: matter_state_compensation; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.matter_state_compensation (
    id bigint DEFAULT nextval('public.matter_state_compensation_id_seq'::regclass) NOT NULL,
    matter_id bigint NOT NULL,
    obligor_org_name character varying(255),
    obligor_org_type character varying(50),
    case_source character varying(50),
    damage_description text,
    criminal_case_terminated boolean,
    criminal_case_no character varying(100),
    compensation_committee character varying(255),
    ...
    admin_litigation_court_name character varying(255),
...
--
-- Name: TABLE matter_state_compensation; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.matter_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.obligor_org_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.obligor_org_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.case_source; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.damage_description; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.criminal_case_terminated; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.criminal_case_no; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.compensation_committee; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.application_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.acceptance_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.decision_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.reconsideration_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.reconsideration_decision_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.committee_app_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.committee_decision_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.admin_litigation_filing_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.admin_litigation_court_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.claim_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.compensation_items; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.decision_result; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.approved_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.payment_status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN matter_state_compensation.payment_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_access_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_access_log (
    id bigint NOT NULL,
    token_id bigint NOT NULL,
    client_id bigint NOT NULL,
    matter_id bigint,
    request_path character varying(200) NOT NULL,
    ...
    error_message character varying(500),
    access_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    version integer DEFAULT 1
);


--
-- Name: TABLE openapi_access_log; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_access_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_access_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_access_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_access_log_id_seq OWNED BY public.openapi_access_log.id;


--
-- Name: openapi_client_file; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_client_file (
    id bigint NOT NULL,
    matter_id bigint NOT NULL,
    client_id bigint NOT NULL,
    client_name character varying(200),
    ...
    file_category character varying(50) DEFAULT 'OTHER'::character varying,
    description text,
    external_file_id character varying(255) NOT NULL,
    external_file_url character varying(1000) NOT NULL,
...
--
-- Name: TABLE openapi_client_file; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.matter_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.client_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.client_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.file_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.original_file_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.file_size; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.file_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.file_category; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.description; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.external_file_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.external_file_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.uploaded_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.uploaded_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.local_document_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.target_dossier_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.synced_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.synced_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_file.error_message; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_client_file_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_client_file_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_client_file_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_client_file_id_seq OWNED BY public.openapi_client_file.id;


--
-- Name: openapi_client_token; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_client_token (
    id bigint NOT NULL,
...
--
-- Name: TABLE openapi_client_token; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_token.token; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_token.scope; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_token.max_access_count; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_client_token.ip_whitelist; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_client_token_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_client_token_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_client_token_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_client_token_id_seq OWNED BY public.openapi_client_token.id;


--
-- Name: openapi_matter_share_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_matter_share_config (
    id bigint NOT NULL,
    matter_id bigint NOT NULL,
    share_basic_info boolean DEFAULT true,
    share_progress boolean DEFAULT true,
    share_task_list boolean DEFAULT false,
    share_deadline boolean DEFAULT true,
    share_document_list boolean DEFAULT false,
    share_team_info boolean DEFAULT true,
    share_fee_info boolean DEFAULT false,
    hidden_fields character varying(1000),
...
--
-- Name: TABLE openapi_matter_share_config; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_matter_share_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_matter_share_config_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_matter_share_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_matter_share_config_id_seq OWNED BY public.openapi_matter_share_config.id;


--
-- Name: openapi_push_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_push_config (
    id bigint NOT NULL,
    matter_id bigint NOT NULL,
    client_id bigint NOT NULL,
    enabled boolean DEFAULT false,
    scopes character varying(500),
    auto_push_on_update boolean DEFAULT false,
...
--
-- Name: TABLE openapi_push_config; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_push_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_push_config_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_push_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_push_config_id_seq OWNED BY public.openapi_push_config.id;


--
-- Name: openapi_push_record; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_push_record (
    id bigint NOT NULL,
    matter_id bigint NOT NULL,
    client_id bigint NOT NULL,
...
--
-- Name: TABLE openapi_push_record; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_push_record.data_snapshot; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_push_record.external_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN openapi_push_record.external_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_push_record_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_push_record_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_push_record_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_push_record_id_seq OWNED BY public.openapi_push_record.id;


--
-- Name: openapi_verification_code; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.openapi_verification_code (
    id bigint NOT NULL,
...
--
-- Name: TABLE openapi_verification_code; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: openapi_verification_code_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.openapi_verification_code_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: openapi_verification_code_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.openapi_verification_code_id_seq OWNED BY public.openapi_verification_code.id;
...
--
-- Name: sys_cause_of_action; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sys_cause_of_action (
    id bigint NOT NULL,
    code character varying(50) NOT NULL,
    name character varying(200) NOT NULL,
    cause_type character varying(20) NOT NULL,
...
--
-- Name: TABLE sys_cause_of_action; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.sys_cause_of_action IS '案由/罪名数据表';


--
-- Name: COLUMN sys_cause_of_action.code; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.code IS '案由代码';


--
-- Name: COLUMN sys_cause_of_action.name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.name IS '案由名称';


--
-- Name: COLUMN sys_cause_of_action.cause_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.cause_type IS '类型: CIVIL-民事, CRIMINAL-刑事, ADMIN-行政';


--
-- Name: COLUMN sys_cause_of_action.category_code; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.category_code IS '所属大类代码';


--
-- Name: COLUMN sys_cause_of_action.category_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.category_name IS '所属大类名称';


--
-- Name: COLUMN sys_cause_of_action.parent_code; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.parent_code IS '父级案由代码';


--
-- Name: COLUMN sys_cause_of_action.level; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.level IS '层级';


--
-- Name: COLUMN sys_cause_of_action.sort_order; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.sort_order IS '排序号';


--
-- Name: COLUMN sys_cause_of_action.is_active; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sys_cause_of_action.is_active IS '是否启用';


--
-- Name: sys_cause_of_action_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sys_cause_of_action_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sys_cause_of_action_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sys_cause_of_action_id_seq OWNED BY public.sys_cause_of_action.id;
...
--
-- Name: COLUMN sys_department.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: sys_holiday_cache; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.sys_holiday_cache (
    ...
    day_type_name character varying(20),
    holiday_name character varying(50),
    is_off boolean NOT NULL,
    data_source character varying(20) DEFAULT 'TIMOR'::character varying,
...
--
-- Name: TABLE sys_holiday_cache; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_holiday_cache.day_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_holiday_cache.is_off; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: sys_holiday_cache_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sys_holiday_cache_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sys_holiday_cache_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sys_holiday_cache_id_seq OWNED BY public.sys_holiday_cache.id;
...
--
-- Name: COLUMN sys_migration.migration_no; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_migration.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_migration.script_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_migration.script_path; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sys_migration.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_wecom; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sys_user_wecom (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    wecom_userid character varying(100),
    wecom_mobile character varying(20),
    enabled boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    version integer DEFAULT 1
...
--
-- Name: TABLE sys_user_wecom; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_wecom_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sys_user_wecom_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sys_user_wecom_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sys_user_wecom_id_seq OWNED BY public.sys_user_wecom.id;
...
--
-- Name: COLUMN workbench_approval.version; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.report_no; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.report_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.report_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.format; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.file_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.bucket_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.storage_path; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.physical_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.file_hash; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.file_size; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.parameters; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.generated_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.generated_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN workbench_report.generated_by_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_monthly_bill id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_monthly_bill ALTER COLUMN id SET DEFAULT nextval('public.ai_monthly_bill_id_seq'::regclass);


--
-- Name: ai_pricing_config id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_pricing_config ALTER COLUMN id SET DEFAULT nextval('public.ai_pricing_config_id_seq'::regclass);
...
--
-- Name: ai_user_quota id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_user_quota ALTER COLUMN id SET DEFAULT nextval('public.ai_user_quota_id_seq'::regclass);
...
--
-- Name: openapi_access_log id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_access_log ALTER COLUMN id SET DEFAULT nextval('public.openapi_access_log_id_seq'::regclass);


--
-- Name: openapi_client_file id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_client_file ALTER COLUMN id SET DEFAULT nextval('public.openapi_client_file_id_seq'::regclass);


--
-- Name: openapi_client_token id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_client_token ALTER COLUMN id SET DEFAULT nextval('public.openapi_client_token_id_seq'::regclass);


--
-- Name: openapi_matter_share_config id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_matter_share_config ALTER COLUMN id SET DEFAULT nextval('public.openapi_matter_share_config_id_seq'::regclass);


--
-- Name: openapi_push_config id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_push_config ALTER COLUMN id SET DEFAULT nextval('public.openapi_push_config_id_seq'::regclass);


--
-- Name: openapi_push_record id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_push_record ALTER COLUMN id SET DEFAULT nextval('public.openapi_push_record_id_seq'::regclass);


--
-- Name: openapi_verification_code id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_verification_code ALTER COLUMN id SET DEFAULT nextval('public.openapi_verification_code_id_seq'::regclass);
...
--
-- Name: sys_cause_of_action id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_cause_of_action ALTER COLUMN id SET DEFAULT nextval('public.sys_cause_of_action_id_seq'::regclass);
...
--
-- Name: sys_holiday_cache id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_holiday_cache ALTER COLUMN id SET DEFAULT nextval('public.sys_holiday_cache_id_seq'::regclass);
...
--
-- Name: sys_user_wecom id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_user_wecom ALTER COLUMN id SET DEFAULT nextval('public.sys_user_wecom_id_seq'::regclass);
...
--
-- Name: admin_asset pk_admin_asset; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_asset_record pk_admin_asset_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_purchase_item pk_admin_purchase_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_purchase_receive pk_admin_purchase_receive; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_purchase_request pk_admin_purchase_request; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_supplier pk_admin_supplier; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ai_monthly_bill pk_ai_monthly_bill; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ai_pricing_config pk_ai_pricing_config; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ai_user_quota pk_ai_user_quota; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive pk_archive; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_borrow pk_archive_borrow; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_data_source pk_archive_data_source; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_location pk_archive_location; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_operation_log pk_archive_operation_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: article_collection pk_article_collection; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: article_comment pk_article_comment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: asset_inventory pk_asset_inventory; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: asset_inventory_detail pk_asset_inventory_detail; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: case_category pk_case_category; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: case_library pk_case_library; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: case_study_note pk_case_study_note; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contract_payment_schedule pk_contract_payment_schedule; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contract_template pk_contract_template; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client pk_crm_client; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_change_history pk_crm_client_change_history; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_contact_record pk_crm_client_contact_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_related_company pk_crm_client_related_company; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_shareholder pk_crm_client_shareholder; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_tag pk_crm_client_tag; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_tag_relation pk_crm_client_tag_relation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_conflict_check pk_crm_conflict_check; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_conflict_check_item pk_crm_conflict_check_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_contact pk_crm_contact; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_lead pk_crm_lead; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_lead_follow_up pk_crm_lead_follow_up; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_access_log pk_doc_access_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_category pk_doc_category; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_document pk_doc_document; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_template pk_doc_template; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_version pk_doc_version; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dossier_template pk_dossier_template; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dossier_template_item pk_dossier_template_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: evidence_cross_exam pk_evidence_cross_exam; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: evidence_list pk_evidence_list; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fin_payment_amendment pk_fin_payment_amendment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_commission pk_finance_commission; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_commission_detail pk_finance_commission_detail; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_commission_rule pk_finance_commission_rule; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_contract pk_finance_contract; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_contract_amendment pk_finance_contract_amendment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_cost_allocation pk_finance_cost_allocation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_cost_split pk_finance_cost_split; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_expense pk_finance_expense; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_fee pk_finance_fee; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_invoice pk_finance_invoice; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_payment pk_finance_payment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_prepayment pk_finance_prepayment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_prepayment_usage pk_finance_prepayment_usage; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: go_out_record pk_go_out_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hourly_rate pk_hourly_rate; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_career_level pk_hr_career_level; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_contract pk_hr_contract; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_development_milestone pk_hr_development_milestone; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_development_plan pk_hr_development_plan; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_employee pk_hr_employee; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_deduction pk_hr_payroll_deduction; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_income pk_hr_payroll_income; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_item pk_hr_payroll_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_sheet pk_hr_payroll_sheet; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_performance_evaluation pk_hr_performance_evaluation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_performance_indicator pk_hr_performance_indicator; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_performance_score pk_hr_performance_score; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_performance_task pk_hr_performance_task; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_promotion_application pk_hr_promotion_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_promotion_review pk_hr_promotion_review; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_regularization pk_hr_regularization; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_resignation pk_hr_resignation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_training pk_hr_training; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_training_record pk_hr_training_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: knowledge_article pk_knowledge_article; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: knowledge_collection pk_knowledge_collection; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: law_category pk_law_category; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: law_regulation pk_law_regulation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leave_application pk_leave_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leave_balance pk_leave_balance; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leave_type pk_leave_type; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: letter_application pk_letter_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: letter_template pk_letter_template; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter pk_matter; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_client pk_matter_client; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_deadline pk_matter_deadline; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_dossier_item pk_matter_dossier_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_participant pk_matter_participant; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_state_compensation pk_matter_state_compensation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_booking pk_meeting_booking; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_record pk_meeting_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_room pk_meeting_room; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: openapi_access_log pk_openapi_access_log; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_access_log
    ADD CONSTRAINT pk_openapi_access_log PRIMARY KEY (id);


--
-- Name: openapi_client_file pk_openapi_client_file; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_client_file
    ADD CONSTRAINT pk_openapi_client_file PRIMARY KEY (id);


--
-- Name: openapi_client_token pk_openapi_client_token; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_client_token
    ADD CONSTRAINT pk_openapi_client_token PRIMARY KEY (id);


--
-- Name: openapi_matter_share_config pk_openapi_matter_share_config; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_matter_share_config
    ADD CONSTRAINT pk_openapi_matter_share_config PRIMARY KEY (id);


--
-- Name: openapi_push_config pk_openapi_push_config; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_push_config
    ADD CONSTRAINT pk_openapi_push_config PRIMARY KEY (id);


--
-- Name: openapi_push_record pk_openapi_push_record; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_push_record
    ADD CONSTRAINT pk_openapi_push_record PRIMARY KEY (id);


--
-- Name: openapi_verification_code pk_openapi_verification_code; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_verification_code
    ADD CONSTRAINT pk_openapi_verification_code PRIMARY KEY (id);


--
-- Name: overtime_application pk_overtime_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_check pk_quality_check; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_check_detail pk_quality_check_detail; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_check_standard pk_quality_check_standard; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_issue pk_quality_issue; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: risk_warning pk_risk_warning; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: seal_application pk_seal_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: seal_info pk_seal_info; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: seal_usage_record pk_seal_usage_record; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_announcement pk_sys_announcement; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_backup pk_sys_backup; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_cause_of_action pk_sys_cause_of_action; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_config pk_sys_config; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover pk_sys_data_handover; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover_detail pk_sys_data_handover_detail; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_sync_log pk_sys_data_sync_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_department pk_sys_department; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_dict_item pk_sys_dict_item; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_dict_type pk_sys_dict_type; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_export_log pk_sys_export_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_external_integration pk_sys_external_integration; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_holiday_cache pk_sys_holiday_cache; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_login_log pk_sys_login_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_menu pk_sys_menu; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_migration pk_sys_migration; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_notification pk_sys_notification; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_operation_log pk_sys_operation_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_permission_change_log pk_sys_permission_change_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role pk_sys_role; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role_change_log pk_sys_role_change_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role_menu pk_sys_role_menu; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user pk_sys_user; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_role pk_sys_user_role; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_session pk_sys_user_session; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_wecom pk_sys_user_wecom; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: task_comment pk_task_comment; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timer_session pk_timer_session; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timesheet_summary pk_timesheet_summary; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_approval pk_workbench_approval; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_report pk_workbench_report; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_report_template pk_workbench_report_template; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_scheduled_report pk_workbench_scheduled_report; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_scheduled_report_log pk_workbench_scheduled_report_log; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_asset uk_admin_asset_asset_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_purchase_receive uk_admin_purchase_receive_receive_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_purchase_request uk_admin_purchase_request_request_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_supplier uk_admin_supplier_supplier_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ai_user_quota uk_ai_quota_user; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive uk_archive_archive_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_borrow uk_archive_borrow_borrow_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archive_location uk_archive_location_location_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: asset_inventory uk_asset_inventory_inventory_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contract_participant uk_contract_participant_contract_id_user_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contract_template uk_contract_template_template_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client uk_crm_client_client_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_tag_relation uk_crm_client_tag_relation_client_id_tag_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_client_tag uk_crm_client_tag_tag_name; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_conflict_check uk_crm_conflict_check_check_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_lead uk_crm_lead_lead_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_document uk_doc_document_doc_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_template uk_doc_template_template_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doc_version uk_doc_version_document_id_version; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: evidence uk_evidence_evidence_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: evidence_list uk_evidence_list_list_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_commission uk_finance_commission_commission_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_commission_rule uk_finance_commission_rule_rule_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_contract_amendment uk_finance_contract_amendment_amendment_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_contract uk_finance_contract_contract_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_expense uk_finance_expense_expense_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_fee uk_finance_fee_fee_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_invoice uk_finance_invoice_invoice_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_payment uk_finance_payment_payment_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: finance_prepayment uk_finance_prepayment_prepayment_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: go_out_record uk_go_out_record_record_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_career_level uk_hr_career_level_level_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_development_plan uk_hr_development_plan_plan_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_employee uk_hr_employee_employee_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_item uk_hr_payroll_item_payroll_sheet_id_employee_id_deleted; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_sheet uk_hr_payroll_sheet_payroll_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_sheet uk_hr_payroll_sheet_payroll_year_payroll_month_deleted; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_promotion_application uk_hr_promotion_application_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_regularization uk_hr_regularization_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_resignation uk_hr_resignation_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leave_application uk_leave_application_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leave_type uk_leave_type_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: letter_application uk_letter_application_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: letter_template uk_letter_template_template_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter uk_matter_matter_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_participant uk_matter_participant_matter_id_user_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_booking uk_meeting_booking_booking_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_record uk_meeting_record_record_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meeting_room uk_meeting_room_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: openapi_client_token uk_openapi_client_token_token; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_client_token
    ADD CONSTRAINT uk_openapi_client_token_token UNIQUE (token);


--
-- Name: openapi_matter_share_config uk_openapi_matter_share_config_matter_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_matter_share_config
    ADD CONSTRAINT uk_openapi_matter_share_config_matter_id UNIQUE (matter_id);


--
-- Name: openapi_push_config uk_openapi_push_config_matter_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.openapi_push_config
    ADD CONSTRAINT uk_openapi_push_config_matter_id UNIQUE (matter_id);


--
-- Name: openapi_verification_code uk_openapi_verification_code_verification_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: overtime_application uk_overtime_application_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_check uk_quality_check_check_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_check_standard uk_quality_check_standard_standard_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quality_issue uk_quality_issue_issue_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: risk_warning uk_risk_warning_warning_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: seal_application uk_seal_application_application_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: seal_info uk_seal_info_seal_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_backup uk_sys_backup_backup_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_cause_of_action uk_sys_cause_of_action_code_type; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_config uk_sys_config_config_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover uk_sys_data_handover_handover_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_dict_type uk_sys_dict_type_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_external_integration uk_sys_external_integration_integration_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_holiday_cache uk_sys_holiday_cache_date; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_migration uk_sys_migration_migration_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role_menu uk_sys_role_menu_role_id_menu_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role uk_sys_role_role_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_role uk_sys_user_role_user_id_role_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user uk_sys_user_username; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_wecom uk_sys_user_wecom_user_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: task uk_task_task_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timesheet_summary uk_timesheet_summary_user_id_matter_id_year_month; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timesheet uk_timesheet_timesheet_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_approval uk_workbench_approval_approval_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_report uk_workbench_report_report_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_report_template uk_workbench_report_template_template_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: workbench_scheduled_report uk_workbench_scheduled_report_task_no; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_ai_bill_period; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_bill_period ON public.ai_monthly_bill USING btree (bill_year, bill_month);


--
-- Name: idx_ai_bill_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_bill_status ON public.ai_monthly_bill USING btree (deduction_status);


--
-- Name: idx_ai_bill_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_bill_user ON public.ai_monthly_bill USING btree (user_id);


--
-- Name: idx_ai_usage_dept; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_usage_dept ON public.ai_usage_log USING btree (department_id);
...
CREATE INDEX idx_ai_usage_model ON public.ai_usage_log USING btree (integration_code);


--
-- Name: idx_ai_usage_request_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_usage_request_type ON public.ai_usage_log USING btree (request_type);


--
-- Name: idx_ai_usage_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_usage_time ON public.ai_usage_log USING btree (created_at);
...
--
-- Name: idx_ai_usage_user_month; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_usage_user_month ON public.ai_usage_log USING btree (user_id, date_trunc('month'::text, created_at));
...
CREATE INDEX idx_cause_active ON public.sys_cause_of_action USING btree (is_active);


--
-- Name: idx_cause_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cause_category ON public.sys_cause_of_action USING btree (category_code);


--
-- Name: idx_cause_code; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cause_code ON public.sys_cause_of_action USING btree (code);


--
-- Name: idx_cause_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cause_parent ON public.sys_cause_of_action USING btree (parent_code);


--
-- Name: idx_cause_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cause_type ON public.sys_cause_of_action USING btree (cause_type);
...
--
-- Name: idx_client_file_client; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_file_client ON public.openapi_client_file USING btree (client_id);


--
-- Name: idx_client_file_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_file_created ON public.openapi_client_file USING btree (created_at DESC);


--
-- Name: idx_client_file_external; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_file_external ON public.openapi_client_file USING btree (external_file_id);


--
-- Name: idx_client_file_matter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_file_matter ON public.openapi_client_file USING btree (matter_id);


--
-- Name: idx_client_file_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_client_file_status ON public.openapi_client_file USING btree (status);
...
--
-- Name: idx_crm_contact_client_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crm_contact_is_primary; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_doc_document_display_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_doc_document_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_document_source ON public.doc_document USING btree (source_module, source_id);


--
-- Name: idx_doc_document_source_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_document_source_type ON public.doc_document USING btree (source_type);
...
--
-- Name: idx_holiday_is_off; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_holiday_is_off ON public.sys_holiday_cache USING btree (is_off);


--
-- Name: idx_holiday_year_month; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_holiday_year_month ON public.sys_holiday_cache USING btree (year, month);
...
--
-- Name: idx_msc_decision_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_msc_decision_date ON public.matter_state_compensation USING btree (decision_date);


--
-- Name: idx_msc_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_msc_deleted ON public.matter_state_compensation USING btree (deleted);


--
-- Name: idx_msc_matter_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_msc_matter_id ON public.matter_state_compensation USING btree (matter_id);


--
-- Name: idx_msc_matter_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_msc_matter_unique ON public.matter_state_compensation USING btree (matter_id) WHERE (deleted = false);


--
-- Name: idx_msc_obligor_org_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_msc_obligor_org_type ON public.matter_state_compensation USING btree (obligor_org_type);
...
--
-- Name: idx_openapi_log_access_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_log_access_at ON public.openapi_access_log USING btree (access_at);


--
-- Name: idx_openapi_log_client; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_log_client ON public.openapi_access_log USING btree (client_id);


--
-- Name: idx_openapi_log_matter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_log_matter ON public.openapi_access_log USING btree (matter_id);


--
-- Name: idx_openapi_log_token; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_log_token ON public.openapi_access_log USING btree (token_id);


--
-- Name: idx_openapi_token_client; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_token_client ON public.openapi_client_token USING btree (client_id);


--
-- Name: idx_openapi_token_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_token_expires ON public.openapi_client_token USING btree (expires_at);


--
-- Name: idx_openapi_token_matter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_token_matter ON public.openapi_client_token USING btree (matter_id);


--
-- Name: idx_openapi_token_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_token_status ON public.openapi_client_token USING btree (status);


--
-- Name: idx_openapi_verify_business; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_verify_business ON public.openapi_verification_code USING btree (business_id);


--
-- Name: idx_openapi_verify_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_openapi_verify_type ON public.openapi_verification_code USING btree (verification_type);
...
--
-- Name: idx_prepayment_client_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_prepayment_contract_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_prepayment_matter_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_prepayment_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_prepayment_usage_fee_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_prepayment_usage_prepayment_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_push_config_matter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_config_matter ON public.openapi_push_config USING btree (matter_id);


--
-- Name: idx_push_record_client; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_record_client ON public.openapi_push_record USING btree (client_id);


--
-- Name: idx_push_record_matter; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_record_matter ON public.openapi_push_record USING btree (matter_id);


--
-- Name: idx_push_record_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_record_status ON public.openapi_push_record USING btree (status);
...
--
-- Name: idx_seal_application_file_hash; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_seal_application_storage_path; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_file_hash; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_generated_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_generated_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_report_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workbench_report_storage_path; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uk_ai_bill_month; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uk_ai_bill_month ON public.ai_monthly_bill USING btree (bill_year, bill_month, user_id) WHERE (deleted = false);


--
-- Name: uk_ai_pricing; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uk_ai_pricing ON public.ai_pricing_config USING btree (integration_code, COALESCE(model_name, ''::character varying)) WHERE (deleted = false);
...
--
-- Name: hr_payroll_deduction fk_hr_payroll_deduction_hr_payroll_item_payroll_item_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_income fk_hr_payroll_income_hr_payroll_item_payroll_item_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_item fk_hr_payroll_item_hr_employee_employee_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hr_payroll_item fk_hr_payroll_item_hr_payroll_sheet_payroll_sheet_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: matter_state_compensation fk_msc_matter; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.matter_state_compensation
    ADD CONSTRAINT fk_msc_matter FOREIGN KEY (matter_id) REFERENCES public.matter(id) ON DELETE CASCADE;
...
--
-- Name: sys_data_handover_detail fk_sys_data_handover_detail_sys_data_handover_handover_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover fk_sys_data_handover_sys_user_confirmed_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover fk_sys_data_handover_sys_user_from_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover fk_sys_data_handover_sys_user_submitted_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_data_handover fk_sys_data_handover_sys_user_to_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_permission_change_log fk_sys_permission_change_log_sys_role_role_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_permission_change_log fk_sys_permission_change_log_sys_user_changed_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role_change_log fk_sys_role_change_log_sys_user_changed_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_role_change_log fk_sys_role_change_log_sys_user_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sys_user_wecom fk_sys_user_wecom_sys_user_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sys_user_wecom
    ADD CONSTRAINT fk_sys_user_wecom_sys_user_user_id FOREIGN KEY (user_id) REFERENCES public.sys_user(id);
...
\unrestrict 63gu8aaacxKAJaL77MK3UJORu0HNkyB4Esh5aTHwcDN6GjzUaDcE5rilgOaHdr4
